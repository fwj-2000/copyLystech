export default {
  ...
  login: {
    ...
    name: 'Die cutting management system',
    subTitle: 'The die-cutting management system is a diversified comprehensive management platform',
    subTitle3: 'Login with account password',
