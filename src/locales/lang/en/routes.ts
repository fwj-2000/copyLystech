export default {
  ...
  dashboard: 'dashboard',
  'dashboard-operate': 'operation',
  'dashboard-production': 'production',
  'production-manualYield': 'manualYield',
  'production-completionYield': 'completionYield',
  'production-OEE': 'OEE',
  'production-temperatureHumidityMonitor': 'temperatureHumidityMonitor',
  onlineDev: 'OnlineDev',
