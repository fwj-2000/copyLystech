export default {
  ...
  email:{
    ...
    selectContactGroup:'选择联系人组',
    contacts:'通讯录',
    editContacts:'编辑联系人',
    editContactGroup:'配置联系人组',
    addGroup:'添加组',
    // sendSuccess: '发送成功',
    // sendError: '发送失败',
    // sendWarn: '请选择收件人',
    ...
    // inputPlaceholder: '请输入邮件内容',
    // modalContent: '请输入邮件内容',
    // modalTip: '请选择收件人',
    // selectContactTitle: '选择联系人',
    // selectContactSuccess: '成功选择收件人',
    // selectContactError: '请选择收件人',
    // selectContactClose: '关闭',
    // selectContactPlaceholder: '请选择收件人',
    // selectContactTip: '请选择收件人'
  }
};
