...
import { DemoParams, DemoListGetResultModel, DemoOptionsItem, selectParams } from './config';
 ...
 */
export const optionsListApi = (params?: selectParams) => defHttp.get<DemoOptionsItem[]>({ url: '/select/getDemoOptions', params });
