...
<script lang="ts" setup>
  ...
  import { getresignationrate, exportResignationRate } from '/@/api/dashbord/hr';
  ...
  defineOptions({ name: 'dashboard-humanResources-turnoverRate' });
  ...
  const handleExport = () => {
    ...
    exportResignationRate(getCommonReqParams(searchFormValue.value)).then(res => {
