...
export const getAllColumns = (): BaseVxeTableTypes.Columns => {
  const columns = [
    ...
    },
    {
      ...
      // params: {
      //   getPathUrl: () => {
      //     return '/dashboard/operation/productionAndSalesRate/group';
      //   },
    ...
    { field: 'metric' },
    {
      ...
      params: {
        ...
        getPathParams: ({ row, column, searchFormValue }) => {
          ...
          console.log('🚀 ~ getAllColumns ~ searchFormValue: 三阶', searchFormValue);
            ...
            case '需求量(W)':
              return dimension === 'week'
                ? {
                    ...
                    period,
                    item,
                    newOldProject: period === 'all' || period === '/' ? '' : period,
                  }
                : {
                    orgCode,
