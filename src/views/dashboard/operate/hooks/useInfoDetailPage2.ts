...
export function useInfoDetailPage2(params: InfoDetailPageHookParams) {
  // 下载明细加载
  const exportLoading = ref(false);

  const { api, searchFormValue, showColumns, afterFetch: afterFetch, downloadApi } = params;
