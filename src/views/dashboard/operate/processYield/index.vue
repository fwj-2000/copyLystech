      ...
      <div class="dashboard-content-container">
        <SpinContent v-bind="{
          ...
          <GroupData v-bind="{
            ...
            trendUrl: '/dashboard/operate/processYield/detail',
            listData,
            searchFormValue,
...
import Chart from '/@/views/dashboard/operate/metricsCenter/components/ProcessYield/Chart/index.vue';
...
import { getProcessyieldSummarydata } from '/@/api/dashbord/operate';

defineOptions({ name: 'dashboard-operate-processYield' });
...
const { listData, searchFormValue, loading, isRequestError, isEmptyData, t } = useTilePage({
  requestMth: getProcessyieldSummarydata,
});
</script>
