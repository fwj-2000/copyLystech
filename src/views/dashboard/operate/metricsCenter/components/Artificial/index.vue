      ...
      <CompoHead>
        <template #left>
          <div class="flex">
            ...
            <div class="text-hover" @click="goPageMth('/dashboard/operate/artificial')">
              <span> {{ t('views.dashboard.operate.artificial.title') }}</span>
        ...
        <template #right>
          <img
            ...
            @click="
              goPage('/dashboard/operate/ranking', {
                name: EModules.ARTIFICIAL,
                dimension: TimeDimension.WEEK,
                date: props.queryInfo.date.subtract(7, 'day').format('YYYY-MM-DD'),
              })
            " />
          <img :src="chartSvg" class="zoom-icon mr-6px" @click="goPageMth('/dashboard/operate/artificial/detail')" />
...
<script lang="ts" setup>
  ...
  import { getFinanceeconomicdata } from '/@/api/dashbord/operate';
