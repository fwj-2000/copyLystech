      ...
      <CompoHead>
        <template #left>
          <div class="flex">
            ...
            <div class="text-hover" @click="goPageMth('/dashboard/operate/financeeconomic')">
        ...
        <template #right>
          ...
          <img :src="chartSvg" class="zoom-icon mr-6px" @click="goPageMth('/dashboard/operate/financeeconomic/detail')" />
