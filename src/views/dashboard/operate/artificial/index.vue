  ...
  <div class="dashboard-page-container">
    ...
    <div class="dashboard-content-container">
      <SpinContent
        ...
        <GroupData
          v-bind="{
            title: t('views.dashboard.operate.artificial.title'),
            trendUrl: '/dashboard/operate/artificial/detail',
            listData,
            searchFormValue,
...
<script lang="ts" setup>
  ...
  import Chart from '/@/views/dashboard/operate/metricsCenter/components/Artificial/Chart/index.vue';
  ...
  defineOptions({ name: 'dashboard-operate-artificial' });
