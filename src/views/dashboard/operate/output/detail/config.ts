// tooltips 样式
export const getTooltipHtmlStr = (params, suffix = '%') => {
  let start = 0;
  return `
  <div class="normal-tooltips">
    <div class="head-container flex ct-between mb-4px">
      <p>${params[0].axisValue}</p>
      <p style="font-size: 16px;">${params[0].value}万元</p>
    </div>
    <div class="content-container flex column all-start" ${params.length === 3 ? 'style="width: 182px"' : ''}>
