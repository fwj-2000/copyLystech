    ...
    <div class="dashboard-content-container">
      <SpinContent
        ...
        <GroupData
          v-bind="{
            title: '',
            trendUrl: '/dashboard/operate/threePointEightLoss/detail',
            listData,
            searchFormValue,
...
<script lang="ts" setup>
  ...
  import Chart from '/@/views/dashboard/operate/metricsCenter/components/ThreePointEightLoss/Chart/index.vue';
  import { SearchForm } from '/@/views/dashboard/operate/components/SearchForm/index';
  import { SpinContent } from '/@/views/dashboard/operate/components/styleItem/index';
  import { getWorkorderloss38summary, getFinanceeconomicOrdertype } from '/@/api/dashbord/operate';
  import { isEmpty } from 'lodash-es';

  defineOptions({ name: 'dashboard-operate-threePointEightLoss' });
  ...
  const { listData, searchFormValue, loading, isRequestError, isEmptyData, t } = useTilePage({
    ...
    requestMth: getWorkorderloss38summary,
    getParams,
  });
</script>
