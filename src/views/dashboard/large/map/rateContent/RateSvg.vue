...
<template
  ><svg viewBox="0 0 76 76" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="37.9998" cy="37.9998" r="29.7" stroke="#fff" stroke-width="0.9" />
    <!-- 进度条 -->
    <circle
      cx="37.9998"
      cy="37.9998"
    ...
    <text x="38" y="51" font-size="10" font-weight="bold" fill="#fff" text-anchor="middle">%</text>
    <defs>
      <filter
      ...
      <linearGradient :id="`paint1_linear_15266_36631_${props.type}`" x1="37.9998" y1="17.2998" x2="37.9998" y2="58.6998" gradientUnits="userSpaceOnUse">
        <stop :stop-color="mainColor" stop-opacity="0.5" />
        <stop offset="0.475" stop-color="white" stop-opacity="0.05" />
        <stop offset="1" :stop-color="mainColor" stop-opacity="0.5" />
      </linearGradient>
      <linearGradient :id="`paint2_linear_15266_36631_${props.type}`" x1="37.9998" y1="17.2998" x2="37.9998" y2="58.6998" gradientUnits="userSpaceOnUse">
        <stop :stop-color="mainColor" stop-opacity="0.5" />
        <stop offset="0.565" stop-color="white" stop-opacity="0.05" />
        <stop offset="1" :stop-color="mainColor" stop-opacity="0.5" />
      </linearGradient>
    </defs>
  </svg>
