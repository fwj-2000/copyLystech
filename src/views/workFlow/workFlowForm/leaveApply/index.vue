      ...
      <a-row>
        ...
        <a-col :span="12" v-if="judgeShow('applyDate')">
          <a-form-item label="申请日期" name="applyDate">
            <lydc-date-picker v-model:value="dataForm.applyDate" placeholder="申请日期" disabled />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="24" v-if="judgeShow('leaveReason')">
          <a-form-item label="请假原因" name="leaveReason">
            <lydc-textarea v-model:value="dataForm.leaveReason" placeholder="请假原因" :disabled="judgeWrite('leaveReason')" />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="12" v-if="judgeShow('leaveEndTime')">
          <a-form-item label="结束时间" name="leaveEndTime">
            <lydc-date-picker v-model:value="dataForm.leaveEndTime" format="YYYY-MM-DD HH:mm:ss" placeholder="选择日期" :disabled="judgeWrite('leaveEndTime')" />
          </a-form-item>
        </a-col>
