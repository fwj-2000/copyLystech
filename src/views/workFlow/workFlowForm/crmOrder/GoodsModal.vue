<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="选择商品" @ok="handleSubmit" :width="800" class="lydc-list-modal">
    <BasicTable @register="registerTable" class="lydc-sub-table"></BasicTable>
  </BasicModal>
</template>
