<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="数据选择" @ok="handleSubmit" :width="800" class="lydc-list-modal">
    <BasicTable :searchInfo="searchInfo" @register="registerTable" class="lydc-sub-table"></BasicTable>
  </BasicModal>
</template>
