<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="发布" @ok="handleSubmit" class="lydc-release-modal">
          ...
          <div class="release-main">
            <div class="release-item">
              ...
              <a-form-item label="应用" name="pcPortalSystemId" v-if="dataForm.pcPortal">
                <LydcSelect v-model:value="dataForm.pcPortalSystemId" :options="treeData" multiple allowClear />
              </a-form-item>
            ...
            <div class="release-item">
              ...
              <a-form-item label="应用" name="appPortalSystemId" v-if="dataForm.appPortal">
                <LydcSelect v-model:value="dataForm.appPortalSystemId" :options="treeAppData" multiple allowClear />
              </a-form-item>
