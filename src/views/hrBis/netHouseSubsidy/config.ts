...
const { t } = useI18n();
import { getfloorList, getSupRegSelectOptParam } from '/@/api/hr/netHouseSubsidy';
  ...
  return [
    ...
    },
    {
      ...
      componentProps: {
        options: [
          // 5未汇总、6已汇总
          { label: t('hrBis.unsummarized'), value: '5' },
          { label: t('hrBis.Summarized'), value: '6' },
        ],
        allowClear: true,
      },
    },
    {
      ...
      componentProps: {
        ...
        options: [
          ...
          { label: t('dict.hrBisColumn.errorRemarks.5'), value: '数据未归档' },
        ],
        allowClear: true,
      },
    },
