...
<script lang="ts" setup>
  ...
  import { getEngineeringSamplesReport, exportEngineeringSamplesReport } from '/@/api/business/report';
  ...
  const [VxeBasicTable, tableRef] = useVbenVxeGrid({
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.applyNo'),
    //         allowClear: true,
    //       },
    //     },
    //     {
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.applyUserName'),
    //         allowClear: true,
    //       },
    //     },
    //     {
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.insidePartNumber'),
    //         allowClear: true,
    //       },
    //     },
    //     {
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.projectPhase'),
    //         allowClear: true,
    //       },
    //     },
    //     {
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.factory'),
    //         allowClear: true,
    //       },
    //     },
    //     {
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.terminalCustomerPartNumber'),
    //         allowClear: true,
    //       },
    //     },
    //     {
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.immediateCustomerPartNumber'),
    //         allowClear: true,
    //       },
    //     },
    //     {
    ...
    //       component: 'Input',
    //       componentProps: {
    //         placeholder: t('dict.BusinessSamplesReportColumn.immediateCustomerName'),
    //         allowClear: true,
    //       },
    //     },
    //   ],
    ...
    gridOptions: {
      id: 'business-report-engineeringSamples-list',
      ...
      // @ts-ignore
      api: getEngineeringSamplesReport,
      toolbarConfig: {
        refresh: true,
        custom: true,
      },
  ...
  function handleOpenExportModal() {
    ...
    openExportModal(true, {
      ...
      api: (query: any) => exportEngineeringSamplesReport({ ...query, id: query.selectIds }),
