...
<script lang="ts" setup>
  ...
  import { templateDownload, importPreview, importData } from '/@/api/business/project';
  ...
  const { t } = useI18n();
  const tableData = [
    { title: '直接客户项目代码', dataIndex: 'ImmediateCustomerProjectCode', key: 'ImmediateCustomerProjectCode' },
    { title: '直接客户信息', dataIndex: 'ImmediateCustomerCode', key: 'ImmediateCustomerCode' },
    { title: '是否启用', dataIndex: 'Status', key: 'Status' },
    { title: '终端项目代码', dataIndex: 'TerminalCustomerProjectCode', key: 'TerminalCustomerProjectCode' },
    { title: '终端客户代码', dataIndex: 'TerminalCustomerCode', key: 'TerminalCustomerCode' },
    { title: '内部项目代码', dataIndex: 'InsideProjectCode', key: 'InsideProjectCode' },
    { title: '项目阶段', dataIndex: 'Phase', key: 'Phase' },
