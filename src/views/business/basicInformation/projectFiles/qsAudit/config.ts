...
import { QS_STATUS } from '../components/Constant';
...
export const columnsVxe = [
  ...
  { title: '状态', field: 'flowStatus', i18nField: 'CommonCol.status', cellRender: { name: 'Tag', options: FLOWSTATE_LIST }, width: 80 },
  ...
  { title: '操作', field: 'action', slots: { default: 'action' }, fixed: 'right', width: 80 },
];
