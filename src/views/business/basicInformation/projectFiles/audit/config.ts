...
export const columnsVxe = [
  ...
  { field: 'applyCode', title: '项目资料单号', minWidth: 200 },
  {
    title: '产品内部料号',
  ...
  { field: 'files', title: '附件', minWidth: 200, slots: { default: 'files' } },
  {
    field: 'version',
    title: '版本',
    width: 120,
  ...
  { field: 'status', title: '状态', cellRender: { name: 'Tag', options: FLOWSTATE_LIST }, i18nField: 'CommonCol.status' },
