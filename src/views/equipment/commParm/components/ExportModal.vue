...
<script lang="ts" setup>
  ...
  import { exportEquipmentProtocolParmExcel } from '/@/api/equipment/commParm';
  ...
  const columnList = ref<any[]>([
    { fullName: '编码', id: 'code' },
    { fullName: '设备类型', id: 'equipmentType' },
    { fullName: '报头', id: 'header' },
    { fullName: '系统', id: 'systemNumber' },
    { fullName: '参数类型', id: 'parameterType' },
    { fullName: '轴号', id: 'axisNumber' },
    { fullName: '参数代码', id: 'parameterCode' },
    { fullName: '参数名称', id: 'parameterName' },
    { fullName: '参数值', id: 'parameterValue' },
    { fullName: '报尾', id: 'tail' },
  ...
  function handleSubmit() {
    ...
    exportEquipmentProtocolParmExcel(query)
      .then(res => {
