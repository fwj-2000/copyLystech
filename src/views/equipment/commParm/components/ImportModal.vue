...
<script lang="ts" setup>
  ...
  import { templateDownload, importEquipmentProtocolParmPreview, importEquipmentProtocolParmData } from '/@/api/equipment/commParm';
  ...
  const tableData = [
    ...
    { title: '报头', dataIndex: 'header', key: 'header' },
    { title: '系统', dataIndex: 'systemNumber', key: 'systemNumber' },
    { title: '参数类型', dataIndex: 'parameterType', key: 'parameterType' },
    { title: '轴号', dataIndex: 'axisNumber', key: 'axisNumber' },
    { title: '参数代码', dataIndex: 'parameterCode', key: 'parameterCode' },
    { title: '参数名称', dataIndex: 'parameterName', key: 'parameterName' },
    { title: '参数值', dataIndex: 'parameterValue', key: 'parameterValue' },
    { title: '报尾', dataIndex: 'tail', key: 'tail' },
    { title: '是否启用', dataIndex: 'status', key: 'status', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importEquipmentProtocolParmPreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importEquipmentProtocolParmData({ data: state.list })
        .then(res => {
