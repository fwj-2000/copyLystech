<template>
  <div id="ProductionDealMouldBusinessMaintenanceAudit" class="lydc-content-wrapper">
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'warehouse-mouldBusiness-maintenanceRecord' });
  ...
  //         ? todoTableRef.value && todoTableRef.value.searchDataByCode(res?.data?.moldRepairApplyNo || '')
  //         : doneTableRef.value && doneTableRef.value.searchDataByCode(res?.data?.moldRepairApplyNo || '');
  //     });
  //   }
  // }
</script>
