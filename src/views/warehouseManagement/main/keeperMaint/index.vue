...
<script lang="ts" setup>
  ...
  import {
    getWarehouseBaseList,
    bulkReviewWarehouseBase,
    bulkEnableWarehouseBase,
    bulkDisableWarehouseBase,
    bulkDeleteWarehouseBase,
    exportWarehouseBase,
    bulkReverseReviewWarehouseBase,
  } from '/@/api/warehouse/main';
  ...
  defineOptions({ name: 'warehouse-main-keeperMaint' });
  ...
  const [Grid, gridApi] = useVbenVxeGrid({
    ...
    gridOptions: {
      id: 'warehouse-main-keeperMaint',
      showIndexColumn: true,
      columns: columnsVxe,
      api: getWarehouseBaseList,
      beforeFetch: params => {
        return {
          ...params,
        };
  ...
  function handleAction(type) {
    ...
    switch (type) {
      case 1:
        // 审核
        method = bulkReviewWarehouseBase;
        break;
      case 2:
        // 启用
        method = bulkEnableWarehouseBase;
        break;
      case 3:
        // 禁用
        method = bulkDisableWarehouseBase;
        break;
      case 4:
        // 删除
        method = bulkDeleteWarehouseBase;
        break;
      case 5:
        // 反审核
        method = bulkReverseReviewWarehouseBase;
        break;
    }
