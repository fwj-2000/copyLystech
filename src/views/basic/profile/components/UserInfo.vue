        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="性别">
              <lydc-select v-model:value="form2.gender" :options="genderOptions" placeholder="请选择" :fieldNames="{ value: 'enCode' }" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="民族">
              <lydc-select v-model:value="form2.nation" :options="nationOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="证件类型">
              <lydc-select v-model:value="form2.certificatesType" :options="certificatesTypeOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="文化程度">
              <lydc-select v-model:value="form2.education" :options="educationOptions" placeholder="请选择" showSearch />
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="出生年月">
              <lydc-date-picker v-model:value="form2.birthday" placeholder="请选择" format="YYYY-MM-DD" />
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="24">
            <a-form-item label="自我介绍">
              <lydc-textarea v-model:value="form2.signature" :maxlength="300" placeholder="请输入" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label=" ">
            ...
            <a-dropdown trigger="click">
              ...
              <template #overlay>
                <a-menu>
                  ...
                  <a-menu-item key="3">
                    <a-upload v-feature :showUploadList="false" accept="image/*" :before-upload="beforeUpload">
                      <div>图片上传</div>
                    </a-upload>
                  </a-menu-item>
                </a-menu>
...
<script setup lang="ts">
  ...
  import SignModal from '/@/components/Lydc/Sign/src/SignModal.vue';
  import { CheckOutlined } from '@ant-design/icons-vue';
  import { getBase64WithFile } from '/@/components/Lydc/Upload/src/helper';
