<template>
  <BasicPopup
    ...
    <BatchImport
      ...
      :template-api="downloadTemplateSalesForecastHistory"
...
<script lang="ts" setup>
  ...
  import { importSalesForecastHistory, downloadTemplateSalesForecastHistory } from '/@/api/customerSerivce/salesForecast';
  ...
  async function uploadExcelFile(file: { file: File }) {
    return importSalesForecastHistory(file, mainProcess.value).then(res => {
