...
import { exportMaterialExcel } from '/@/api/business/customerMaterial';
...
const columnList = ref<any[]>([
    ...
    { fullName: '内部料号', id: 'InsidePartNumber', },
    { fullName: '内部物料描述', id: 'ProductDesc', },
    { fullName: '客户编码', id: 'CustomerCode', },
    { fullName: '客户物料编码', id: 'CustomerMaterialCode', },
    { fullName: '客户物料描述', id: 'CustomerMaterialDesc', },
    { fullName: '客户物料规格', id: 'CustomerMaterialSpec', },
    { fullName: '单重', id: 'Weight', },
    { fullName: '重量单位', id: 'WeightUnit', },
    { fullName: '币别', id: 'ISOCode', },
    { fullName: '生效日期', id: 'EffectiveDate', format: 'date|YYYY-MM-DD HH:mm:ss' },
    { fullName: '失效日期', id: 'ExpirationDate', format: 'date|YYYY-MM-DD HH:mm:ss' },
    { fullName: '客服', id: 'CustomerService', },
    { fullName: '备注', id: 'Remark', },
    { fullName: '创建人', id: 'CreatorUserName', },
    { fullName: '创建时间', id: 'CreatorTime', format: 'date|YYYY-MM-DD HH:mm:ss' },
    { fullName: '修改人', id: 'LastModifyUserName', },
    { fullName: '修改时间', id: 'LastModifyTime', format: 'date|YYYY-MM-DD HH:mm:ss' },
