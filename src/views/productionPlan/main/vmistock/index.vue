...
<script lang="ts" setup>
  ...
  import { getVMIStock, templateDownload, importSave, importPreview } from '/@/api/mps/productionPlan/vmistock';
  ...
  defineOptions({ name: 'productionPlan-main-vmistock' });
  ...
  const [Grid, { reload, getFetchParams, getFromValue, resetForm, setLatestSubmissionValues, setFieldValue }] = useVbenVxeGrid({
    formOptions: {
      ...
      schema: frmSchema,
      i18nConfig: {
        moduleCode: 'VMIStockColumn',
        transferRange: ['placeholder'],
      },
      handleReset,
    },
    gridOptions: {
      id: 'productionPlan-main-vmistock-list',
