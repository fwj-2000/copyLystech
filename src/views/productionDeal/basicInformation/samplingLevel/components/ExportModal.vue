...
<script lang="ts" setup>
  ...
  import { exportSamplingLevelExcel } from '/@/api/productionDeal/samplingLevel';
  ...
  const columnList = ref<any[]>([
    { fullName: '批量上限', id: 'BatchLimit' },
    { fullName: '批量下限', id: 'BatchLowerLimit' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: 'AQL值', id: 'AQLValue' },
    { fullName: '样本大小', id: 'SampleSize' },
    { fullName: '检验水平', id: 'TestingLevelName' },
    { fullName: '允许数量', id: 'AllowQuantity' },
    { fullName: '拒绝数量', id: 'RejectQuantity' },
  ...
  function handleSubmit() {
    ...
    exportSamplingLevelExcel(query)
      .then(res => {
