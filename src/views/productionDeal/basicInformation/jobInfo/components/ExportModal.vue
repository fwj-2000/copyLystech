...
<script lang="ts" setup>
  ...
  import { exportJobInfoExcel } from '/@/api/productionDeal/jobInfo';
  ...
  const columnList = ref<any[]>([
    { fullName: '岗位编码', id: 'Code' },
    { fullName: '岗位名称', id: 'Name' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: '岗位描述', id: 'Description' },
    { fullName: '所属部门', id: 'DepartmentName' },
