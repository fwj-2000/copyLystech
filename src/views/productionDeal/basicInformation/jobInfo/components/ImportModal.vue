...
<script lang="ts" setup>
  ...
  import { templateDownload, importJobInfoData, importJobInfoPreview } from '/@/api/productionDeal/jobInfo';
  ...
  const tableData = [
    ...
    { title: '岗位编码', dataIndex: 'Code', key: 'Code', width: 50 },
    { title: '岗位名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: '所属部门', dataIndex: 'DepartmentName', key: 'DepartmentName', width: 50 },
    { title: '岗位描述', dataIndex: 'Description', key: 'Description', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importJobInfoPreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importJobInfoData({ Data: state.list })
        .then(res => {
