...
<script setup lang="ts">
  ...
  import { addLabelTemplateParm, updateLabelTemplateParm, getLabelTemplateParmById } from '/@/api/productionDeal/labelTemplateParm';
  ...
  function init(data) {
    ...
    if (state.dataForm.Id) {
      changeLoading(true);
      getLabelTemplateParmById(state.dataForm.Id).then(res => {
        const data = res.data;
        state.dataForm = data;
  ...
  transformSchemas(schemas, 'LabelTemplateParmColumn', { OrgId: 'OrgName' });
  ...
  async function handleSubmit() {
    ...
    const formMethod = state.dataForm.Id ? updateLabelTemplateParm : addLabelTemplateParm;
    formMethod(query)
      .then(res => {
