...
<script setup lang="ts">
  ...
  import { addBadCode, updateBadCode, getBadCodeById } from '/@/api/productionDeal/badCode';
  ...
  function init(data) {
    ...
    if (state.dataForm.Id) {
      changeLoading(true);
      getBadCodeById(state.dataForm.Id).then(res => {
        const data = res.data;
        state.dataForm = data;
  ...
  transformSchemas(schemas, 'BadCodeColumn', { OrgId: 'OrgName' });
  ...
  async function handleSubmit() {
    ...
    const formMethod = state.dataForm.Id ? updateBadCode : addBadCode;
    formMethod(query)
      .then(res => {
