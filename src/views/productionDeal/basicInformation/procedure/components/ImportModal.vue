...
<script lang="ts" setup>
  ...
  import { templateDownload, importProcedurePreview, importProcedureData } from '/@/api/productionDeal/procedure';
  ...
  const tableData = [
    ...
    { title: '工位名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: '产能主体', dataIndex: 'Mainstay', key: 'Mainstay', width: 50 },
    { title: '关联工序', dataIndex: 'ProcessName', key: 'ProcessName', width: 50 },
    { title: '所属车间', dataIndex: 'WorkshopName', key: 'WorkshopName', width: 50 },
    { title: '制单人员', dataIndex: 'CreateOrderUserName', key: 'CreateOrderUserName', width: 50 },
    { title: '所属产线', dataIndex: 'ProductLineName', key: 'ProductLineName', width: 50 },
    { title: '制单日期', dataIndex: 'CreateOrderDate', key: 'CreateOrderDate', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importProcedurePreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importProcedureData({ Data: state.list })
        .then(res => {
