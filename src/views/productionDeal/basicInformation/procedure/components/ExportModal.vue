...
<script lang="ts" setup>
  ...
  import { exportProcedureExcel } from '/@/api/productionDeal/procedure';
  ...
  const columnList = ref<any[]>([
    { fullName: '工位名称', id: 'Name' },
    { fullName: '产能主体', id: 'Mainstay' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: '关联工序', id: 'ProcessName' },
    { fullName: '所属车间', id: 'WorkshopName' },
    { fullName: '制单人员', id: 'CreateOrderUserName' },
    { fullName: '所属于产线', id: 'ProductLineName' },
    { fullName: '制单日期', id: 'CreateOrderDate' },
