...
<script lang="ts" setup>
  ...
  import { exportClassesExcel } from '/@/api/productionDeal/classes';
  ...
  const columnList = ref<any[]>([
    { fullName: '班次编码', id: 'Code' },
    { fullName: '班次名称', id: 'Name' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: '班次时间段', id: 'ClassesTimeSlot' },
    { fullName: '上班时间1', id: 'OnWorkTimeOne' },
    { fullName: '下班时间1', id: 'OffWorkTimeOne' },
    { fullName: '上班时间2', id: 'OnWorkTimeTwo' },
    { fullName: '下班时间2', id: 'OffWorkTimeTwo' },
    { fullName: '加班上班时间', id: 'OverTimeOnWorkTime' },
    { fullName: '加班下班时间', id: 'OverTimeOffWorkTime' },
