...
<script lang="ts" setup>
  ...
  import { templateDownload, importClassesPreview, importClassesData } from '/@/api/productionDeal/classes';
  ...
  const tableData = [
    ...
    { title: '班次编码', dataIndex: 'Code', key: 'Code', width: 50 },
    { title: '班次名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: '班次时间段', dataIndex: 'ClassesTimeSlot', key: 'ClassesTimeSlot', width: 50 },
    { title: '上班时间1', dataIndex: 'OnWorkTimeOne', key: 'OnWorkTimeOne', width: 50 },
    { title: '下班时间1', dataIndex: 'OffWorkTimeOne', key: 'OffWorkTimeOne', width: 50 },
    { title: '上班时间2', dataIndex: 'OnWorkTimeTwo', key: 'OnWorkTimeTwo', width: 50 },
    { title: '下班时间2', dataIndex: 'OffWorkTimeTwo', key: 'OffWorkTimeTwo', width: 50 },
    { title: '加班上班时间', dataIndex: 'OverTimeOnWorkTime', key: 'OverTimeOnWorkTime', width: 50 },
    { title: '加班下班时间', dataIndex: 'OverTimeOffWorkTime', key: 'OverTimeOffWorkTime', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importClassesPreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importClassesData({ Data: state.list })
        .then(res => {
