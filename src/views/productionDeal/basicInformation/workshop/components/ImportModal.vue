...
<script lang="ts" setup>
  ...
  import { templateDownload, importWorkshopPreview, importWorkshopData } from '/@/api/productionDeal/workshop';
  ...
  const tableData = [
    ...
    { title: '车间代码', dataIndex: 'Code', key: 'Code', width: 50 },
    { title: '车间名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: '物理位置', dataIndex: 'Location', key: 'Location', width: 50 },
    { title: '工作中心', dataIndex: 'WorkCenter', key: 'WorkCenter', width: 50 },
    { title: '控制者', dataIndex: 'Controller', key: 'Controller', width: 50 },
    { title: '描述', dataIndex: 'Description', key: 'Description', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importWorkshopPreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importWorkshopData({ Data: state.list })
        .then(res => {
