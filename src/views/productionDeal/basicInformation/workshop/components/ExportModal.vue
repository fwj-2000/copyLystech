...
<script lang="ts" setup>
  ...
  import { exportWorkshopExcel } from '/@/api/productionDeal/workshop';
  ...
  const columnList = ref<any[]>([
    { fullName: '车间编码', id: 'Code' },
    { fullName: '车间名称', id: 'Name' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: '物理位置', id: 'Location' },
    { fullName: '工作中心', id: 'WorkCenter' },
    { fullName: '控制者', id: 'Controller' },
    { fullName: '描述', id: 'Description' },
