...
<script lang="ts" setup>
  ...
  import { templateDownload, importSkillLevelData, importSkillLevelPreview } from '/@/api/productionDeal/skillLevel';
  ...
  const tableData = [
    ...
    { title: '技能编码', dataIndex: 'Code', key: 'Code', width: 50 },
    { title: '技能名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: '所属岗位', dataIndex: 'JobInfoName', key: 'JobInfoName', width: 50 },
    { title: '技能描述', dataIndex: 'Description', key: 'Description', width: 50 },
    { title: '技能等级', dataIndex: 'SkillLevelName', key: 'SkillLevelName', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importSkillLevelPreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importSkillLevelData({ Data: state.list })
        .then(res => {
