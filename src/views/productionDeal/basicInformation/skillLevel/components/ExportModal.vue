...
<script lang="ts" setup>
  ...
  import { exportSkillLevelExcel } from '/@/api/productionDeal/skillLevel';
  ...
  const columnList = ref<any[]>([
    { fullName: '技能编码', id: 'Code' },
    { fullName: '技能名称', id: 'Name' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: '所属岗位', id: 'JobInfoName' },
    { fullName: '是否启用', id: 'StatusName' },
    { fullName: '技能描述', id: 'Description' },
    { fullName: '技能等级', id: 'SkillLevelName' },
