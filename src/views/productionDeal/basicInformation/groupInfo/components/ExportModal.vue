...
<script lang="ts" setup>
  ...
  import { exportGroupInfoExcel } from '/@/api/productionDeal/groupInfo';
  ...
  const columnList = ref<any[]>([
    { fullName: '组别编码', id: 'Code' },
    { fullName: '组别名称', id: 'Name' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: '主管工号', id: 'GroupJobNumber' },
    { fullName: '组长工号', id: 'GroupJobNumber' },
    { fullName: '物料员工号', id: 'MaterialOfficerJobNumber' },
    { fullName: '额定人员名称', id: 'RatedPersonnelJobNumber' },
    //{ fullName: '额定人员工号', id: 'RatedPersonnelJobNumber' },
    { fullName: '工作描述', id: 'Description' },
