...
<script lang="ts" setup>
  ...
  import { templateDownload, importGroupInfoPreview, importGroupInfoData } from '/@/api/productionDeal/groupInfo';
  ...
  const tableData = [
    ...
    { title: '组别编码', dataIndex: 'Code', key: 'Code', width: 50 },
    { title: '组别名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: '工作描述', dataIndex: 'Description', key: 'Description', width: 50 },
    { title: '主管工号', dataIndex: 'DirectorJobNumber', key: 'DirectorJobNumber', width: 50 },
    { title: '组长工号', dataIndex: 'GroupJobNumber', key: 'GroupJobNumber', width: 50 },
    { title: '物料员工号', dataIndex: 'MaterialOfficerJobNumber', key: 'MaterialOfficerJobNumber', width: 50 },
    { title: '额定人员', dataIndex: 'RatedPersonnelName', key: 'RatedPersonnelName', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importGroupInfoPreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importGroupInfoData({ Data: state.list })
        .then(res => {
