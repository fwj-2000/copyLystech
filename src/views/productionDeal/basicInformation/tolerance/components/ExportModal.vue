...
<script lang="ts" setup>
  ...
  import { exportToleranceExcel } from '/@/api/productionDeal/tolerance';
  ...
  const columnList = ref<any[]>([
    { fullName: '项目号', id: 'ProjectNo' },
    { fullName: '工序', id: 'ProcessName' },
    { fullName: '所属组织', id: 'OrgName' },
    { fullName: 'FAI_NO', id: 'FAINo' },
    { fullName: '图纸管控上限', id: 'DrawingControlUpperLimit' },
    { fullName: '图纸管控下限', id: 'DrawingControlLowerLimit' },
    { fullName: '出货管控上限', id: 'ShipmentControlUpperLimit' },
    { fullName: '出货管控下限', id: 'ShipmentControlLowerLimit' },
    { fullName: '停机管控上限', id: 'ShutdownControlUpperLimit' },
    { fullName: '停机管控下限', id: 'ShutdownControlLowerLimit' },
    { fullName: '建议首件上限', id: 'FirstArticleUpperLimit' },
    { fullName: '建议首件下限', id: 'FirstArticleLowerLimit' },
    { fullName: '是否启用', id: 'StatusName' },
    { fullName: '版本说明', id: 'Remark' },
