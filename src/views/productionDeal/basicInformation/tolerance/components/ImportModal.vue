...
<script lang="ts" setup>
  ...
  import { templateDownload, importTolerancePreview, importToleranceData } from '/@/api/productionDeal/tolerance';
  ...
  const tableData = [
    ...
    { title: '项目号', dataIndex: 'ProjectNo', key: 'ProjectNo', width: 50 },
    { title: '工序', dataIndex: 'ProcessName', key: 'ProcessName', width: 50 },
    { title: 'FAI_NO', dataIndex: 'FAINo', key: 'FAINo', width: 50 },
    { title: '图纸管控上限', dataIndex: 'DrawingControlUpperLimit', key: 'DrawingControlUpperLimit', width: 50 },
    { title: '图纸管控下限', dataIndex: 'DrawingControlLowerLimit', key: 'DrawingControlLowerLimit', width: 50 },
    { title: '出货管控上限', dataIndex: 'ShipmentControlUpperLimit', key: 'ShipmentControlUpperLimit', width: 50 },
    { title: '出货管控下限', dataIndex: 'ShipmentControlLowerLimit', key: 'ShipmentControlLowerLimit', width: 50 },
    { title: '停机管控上限', dataIndex: 'ShutdownControlUpperLimit', key: 'ShutdownControlUpperLimit', width: 50 },
    { title: '停机管控下限', dataIndex: 'ShutdownControlLowerLimit', key: 'ShutdownControlLowerLimit', width: 50 },
    { title: '建议首件上限', dataIndex: 'FirstArticleUpperLimit', key: 'FirstArticleUpperLimit', width: 50 },
    { title: '建议首件下限', dataIndex: 'FirstArticleLowerLimit', key: 'FirstArticleLowerLimit', width: 50 },
  ...
  function handleNext() {
    if (state.activeStep == 0) {
      ...
      importTolerancePreview({ fileName: state.fileName })
        .then(res => {
    ...
    if (state.activeStep == 1) {
      ...
      state.btnLoading = true;
      importToleranceData({ Data: state.list })
        .then(res => {
  ...
  function beforeUpload(file) {
    ...
    if (!isRightSize) createMessage.error(`${t('component.batchImport.fileSizeNotMoreThan')} 500KB`);
    return isRightSize;
  }
