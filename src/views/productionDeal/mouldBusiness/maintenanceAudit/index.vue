...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'productionDeal-mouldBusiness-maintenanceAudit' });
  ...
  //         ? todoTableRef.value && todoTableRef.value.openDetail(res.data)
  //         : doneTableRef.value && doneTableRef.value.openDetail(res.data);
  //     });
  //   }
  // }
</script>
