...
export function buildCurrencyPrice({
  ...
  } else if (purchasingUnit === 'M2' || (purchasingUnit === 'ROLL' && priceUnit === 'M2')) {
  ...
  return [Number.parseFloat(supplierPriceBaseCurrency.toString()), Number.parseFloat(supplierPriceOriginalCurrency.toString())];
}
