...
.tem-container .table-box {
  padding: 0 1px 0 0;
}
.tem-container .demo-form-inline {
  display: flex;
  flex-wrap: wrap;
  justify-content: space-between;
}
.tem-container .temdate {
  text-align: right;
  margin: 20px 60px;
}
.tem-container .seal {
...
.tem-container .tem_list.education-card {
  width: 600px;
  margin: 0 auto;
...
.tem-container .tem_list.education-card h1 {
  text-align: center;
}

.tem-container .tem_list.education-card table {
  width: 100%;
  border-collapse: collapse;
}

.tem-container tem_list.education-card td {
  border: 1px solid #000;
  padding: 8px;
}

.tem-container .training-content {
  margin-top: 20px;
}

.tem-container .training-content h2 {
  margin-bottom: 10px;
}

.tem-container .training-content ul {
  list-style-type: none;
  padding: 0;
}

.tem-container .training-content li {
  margin-bottom: 5px;
}
