<template>
  <BasicModal v-bind="$attrs" class="transfer-modal" @register="registerModal" :width="1200" :title="modalTitle" @ok="handleSubmit" destroyOnClose>
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'LydcUsersSelect', inheritAttrs: false });
