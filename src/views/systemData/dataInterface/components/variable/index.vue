<template>
  <BasicPopup v-bind="$attrs" @register="registerPopup" title="提取变量" class="full-popup">
    <div class="lydc-content-wrapper-search-box pl-10px mt-10px">
    ...
    <BasicTable @register="registerTable" :columns="menuTableColumns" :searchInfo="getSearchInfo">
      <template #tableTitle>
        ...
        <lydc-upload-btn url="/api/system/DataInterfaceVariate/Actions/Import" accept=".ffa" @on-success="reload"></lydc-upload-btn>
      </template>
