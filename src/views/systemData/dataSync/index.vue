  ...
  <div class="lydc-content-wrapper">
    <div class="lydc-content-wrapper-center">
      <div class="lydc-content-wrapper-content bg-white">
        <div class="p-20px">
          <LydcAlert message="温馨提示：数据同步是由A数据库同步到B数据库。" type="warning" show-icon />
        </div>
        <a-form ref="fromRef" :model="dataForm" :rules="dataRule" :labelCol="{ style: { width: '140px' } }" class="">
          ...
          <a-form-item label="数据库连接 To" name="dbConnectionTo">
            <lydc-select v-model:value="dataForm.dbConnectionTo" show-search placeholder="请选择" :options="dbOptions" :fieldNames="{ options: 'children' }" />
