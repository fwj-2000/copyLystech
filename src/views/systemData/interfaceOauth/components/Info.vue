  ...
  <BasicModal v-bind="$attrs" @register="registerModal" title="验证签名使用说明" :footer="null" :width="800">
    <div class="doc-container">
      <div class="docu-container">
        ...
        <h4>生成待签名字符串及Authorization代码示例: ></h4>
...
<span class="token keyword">using</span><span > LYDC.Common.Extension;</span>
<span class="token keyword">namespace LYDC.Systems.System</span>
