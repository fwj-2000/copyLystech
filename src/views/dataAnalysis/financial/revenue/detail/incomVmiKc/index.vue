...
<script lang="ts" setup>
  ...
  import { getIncomVmiKc, ExportIncomVmiKc } from '/@/api/dataAnalysis/revenue';
  ...
  defineOptions({ name: 'dataAnalysis-financial-revenue-incomVmiKc' });
  const columns = ref(getAllColumns());
  const attrs = reactive<VxeGridProps<any>>({
    id: 'dataAnalysis-financial-revenue-incomVmiKc-list',
    filterConfig: {
      remote: true,
    },
    proxyConfig: {
