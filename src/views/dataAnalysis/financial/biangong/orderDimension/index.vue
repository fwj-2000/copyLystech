...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'dataAnalysis-financial-biangong-orderDimension' });
  ...
  const [TableLayout, api] = useTableLayout({
    ...
    tableConfig: {
      ...
      getExportParams: () => {
        ...
        const filename = `订单号维度_${startDim}-${endDim}`;
        return {
          filename,
        };
      },
      api: (params: any) => getDimensionOtherData({ ...params, dimension: 'order' }),
    },
  });
</script>
