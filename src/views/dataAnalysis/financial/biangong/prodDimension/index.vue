...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'dataAnalysis-financial-biangong-prodDimension' });
  ...
  const [TableLayout, api] = useTableLayout({
    ...
    tableConfig: {
      ...
      getExportParams: () => {
        ...
        const filename = `成品编号维度_${startDim}-${endDim}`;
        return {
          filename,
        };
      },
      api: (params: any) => getDimensionOtherData({ ...params, dimension: 'prod' }),
    },
  });
</script>
