...
<script lang="ts" setup>
  ...
  import { detailfactoryselectparam, addorupdatelocalmaint } from '/@/api/dataAnalysis/warehouseKanban';
      ...
      editRender: {
        ...
        props: {
          ...
          onChange: (_value: string, option: any, { row }) => {
            console.log('🚀 ~ _value: string, option: any, { row }:', _value, option);
            row.factory = option.label;
          },
          resultField: 'data',
          labelField: 'Name',
          valueField: 'Code',
  ...
  const gridOptions: VxeGridProps = {
    ...
    editRules: {
      ...
      werks: [{ required: true, message: t('common.required') }],
      lgort: [{ required: true, message: t('common.required') }],
      lgobe: [{ required: true, message: t('common.required') }],
    },
    editConfig: {
      trigger: 'dblclick',
      mode: 'row',
