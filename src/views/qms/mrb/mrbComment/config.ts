...
export const columns: VxeGridPropTypes.Columns = [
  ...
  {
    title: 'SQE',
    field: 'sqeUserName', // 对应接口中的 externalPartNumber
    minWidth: 220,
    sortable: true,
    filters: [{ data: '' }],
    filterRender: {
  ...
  {
    title: 'SQE评审结论',
    field: 'sqeResult', // 对应接口中的 specification
    minWidth: 220,
    sortable: true,
    cellRender: {
      name: 'Tag',
  ...
  // {
  //   title: 'SQE评审意见',
  //   field: 'sqeRemark', // 对应接口中的 specification
  //   minWidth: 220,
  //   sortable: true,
  //   filters: [{ data: '' }],
  //   filterRender: {
  ...
  {
    title: '工程',
    field: 'pdUserName', // 对应接口中的 externalPartNumber
    minWidth: 220,
    sortable: true,
    filters: [{ data: '' }],
    filterRender: {
  ...
  {
    title: '工程评审结论',
    field: 'pdResult', // 对应接口中的 specification
    minWidth: 220,
    sortable: true,
    cellRender: {
      name: 'Tag',
  ...
  {
    title: '采购',
    field: 'purchaseUserName', // 对应接口中的 externalPartNumber
    minWidth: 220,
    sortable: true,
    filters: [{ data: '' }],
    filterRender: {
  ...
  {
    title: '采购评审结论',
    field: 'purchaseResult', // 对应接口中的 specification
    minWidth: 220,
    sortable: true,
    cellRender: {
      name: 'Tag',
