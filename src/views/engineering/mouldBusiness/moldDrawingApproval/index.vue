<template>
  <div id="EngineeringMouldBusinessMoldDrawingApproval" class="lydc-content-wrapper">
    <div class="lydc-content-wrapper-center">
      <div class="lydc-content-wrapper-content bg-white">
        <a-tabs v-model:activeKey="activeKey">
          <a-tab-pane :key="TABS_ENUM.待处理" :tab="t('common.todoText')">
            <DataTable :type="TABS_ENUM.待处理" />
          </a-tab-pane>
          <a-tab-pane :key="TABS_ENUM.已处理" :tab="t('common.doneText')">
            <DataTable :type="TABS_ENUM.已处理" />
          </a-tab-pane>
        </a-tabs>
      </div>
    </div>
...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'engineering-mouldBusiness-moldDrawingApproval' });
