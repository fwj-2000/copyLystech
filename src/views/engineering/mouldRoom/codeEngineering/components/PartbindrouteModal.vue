<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="t('dict.CommonCol.batchBindProcessRoute')" showOkBtn @ok="handleSubmit" :width="950">
...
<script setup lang="ts">
  ...
  import { getelectroderoutelist, partbindroute } from '/@/api/engineering/mould';
