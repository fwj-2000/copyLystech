<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="t('dict.CommonCol.outsource')" showOkBtn @ok="handleSubmit" width="300px" :minHeight="100">
...
<script setup lang="ts">
  ...
  import { moldprogramUpdateoutsource } from '/@/api/engineering/mould';
  ...
  async function handleSubmit() {
    ...
    const res = await moldprogramUpdateoutsource(params).finally(() => {
