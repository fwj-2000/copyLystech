...
<script setup lang="ts">
  ...
  import { addWorkorder, relateworkorder, moldcreatworkorder } from '/@/api/engineering/mould';
  ...
  async function handleSubmit() {
    ...
    const res = await moldcreatworkorder(query).finally(() => {
      changeOkLoading(false);
    });
    // const res = await relateworkorder({ partRelationId: state.value.partRelationId, workOrderNo: addWorkorderRes.data.workOrderNo }).
