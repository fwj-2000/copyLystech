...
export const detailGridColumn: any[] = [
  ...
  },
  {
    ...
    // slots: {
    //   default: 'RepairSolution',
    // },
  },
  {
    title: '维修盘点',
    field: 'repairTakeStock',
    editRender: {
      name: 'Input',
    },
    // slots: {
    //   default: 'RepairTakeStock',
    // },
  },
  {
    title: '改善判定',
...
export const formSchema = [
  {
    ...
    label: '与会人员',
    component: 'CustomUserSelect',
    componentProps: { placeholder: '与会人员', multiple: true },
  },
  {
    field: 'dqeUserId',
    label: '签核',
    component: 'CustomUserSelect',
    componentProps: { placeholder: '签核' },
    rules: [
      {
        required: true,
        trigger: 'change',
  ...
  },
  {
    ...
    label: ' ',
    component: 'CustomUserSelect',
    componentProps: { placeholder: 'PD/leader' },
  },
  {
    field: 'teLeaderId',
    label: ' ',
    component: 'CustomUserSelect',
    componentProps: { placeholder: 'TE主管' },
  },
  {
    field: 'rdLeaderId',
    label: ' ',
    component: 'CustomUserSelect',
    componentProps: { placeholder: '研发经理' },
  },
  {
    field: 'moldUndertakerId',
    label: ' ',
    component: 'CustomUserSelect',
    componentProps: { placeholder: '模具部承办' },
  },
];
