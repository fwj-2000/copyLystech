<template>
  <BasicPopup
    ...
    <template #centerToolbar>
      <a-button v-auth="'btn_agree'" v-if="mode === 'edit'" @click="handleReject" :disabled="agreeLoading" type="primary" ghost
        >{{ t('common.disagree') }}
      </a-button>
      <a-button v-auth="'btn_disagree'" v-if="mode === 'edit'" :loading="agreeLoading" class="mx-12px" @click="handleSubmit('commit')" type="primary"
        >{{ t('common.agree') }}
      </a-button>
    </template>
...
<script setup lang="ts">
  ...
  import { commitEcn, getEcnDetail, getNodeDetail, rejectEcn } from '/@/api/engineering/ecn';
