...
<script setup lang="ts">
  ...
  import { getApplyInfoSchemas, getReplyInfoSchemas } from './viewPopupConfig';
  ...
  async function handleSubmit(isSubmit = false) {
    ...
    console.log('submit:', applyInfoData.innerMaterialNumber, applyInfoData.innerExternalNumber, applyInfoData);
