...
<script lang="ts" setup>
  ...
  const btnList = [
    ...
    { fullName: t('common.detailText'), id: 'btn_detail' },
    ...
    { fullName: '审核', id: 'btn_review' },
    { fullName: '审批', id: 'btn_approve' },
    { fullName: '开启', id: 'btn_enable' },
    { fullName: '禁用', id: 'btn_disable' },
    { fullName: '转办', id: 'btn_transfer' },
    { fullName: '撤回', id: 'btn_recall' },
    { fullName: '驳回', id: 'btn_reject' },
    { fullName: '同意', id: 'btn_agree' },
    { fullName: '终止', id: 'btn_stop' },
    { fullName: '打印', id: 'btn_print' },
    { fullName: '预览下载', id: 'btn_downloadPreview' },
    { fullName: '一键全选', id: 'allin' },
  ];
  ...
  // 动态添加按钮权限
  function createPermission(item) {
    let query = {
      parentId: '-1',
      moduleId: state.id,
