<template>
  <div class="common-container">
    ...
    <a-modal v-model:open="visible" title="选择门户" :width="800" class="lydc-list-modal" @ok="handleSubmit" @cancel="handleCancel">
      <template #closeIcon>
      ...
      <div class="lydc-content-wrapper">
        <div class="lydc-content-wrapper-center">
          <div class="lydc-content-wrapper-content">
            <BasicTable @register="registerTable" :searchInfo="searchInfo" class="lydc-sub-table"></BasicTable>
          </div>
        </div>
      </div>
    </a-modal>
