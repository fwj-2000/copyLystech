<template>
  <BasicDrawer v-bind="$attrs" @register="registerDrawer" :title="title" :width="700" class="full-drawer">
    <a-tabs v-model:activeKey="activeKey" @change="onTabsChange" type="card" class="lydc-content-table-tabs" destroyInactiveTabPane>
    ...
    return [
      {
        ...
        disabled: record.enCode === 'lydc_alldata' && state.activeKey == 1,
