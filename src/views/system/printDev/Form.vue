<template>
  <BasicModal
    ...
    :closable="false"
    :keyboard="false"
    class="lydc-full-modal full-modal"
    destroyOnClose>
    <template #title>
              ...
              <template v-if="column.key === 'relationField'">
                <template v-if="record.sourceType === 2">
                  ...
                  <lydc-date-picker
                    ...
                    placeholder="请选择"
                    clearable />
                  <lydc-input v-else v-model:value="record.relationField" placeholder="请输入" clearable />
                </template>
                <lydc-select v-if="record.sourceType === 4" v-model:value="record.relationField" :options="interfaceSystemOptions" allowClear showSearch />
              </template>
            </template>
            <template #emptyText>
