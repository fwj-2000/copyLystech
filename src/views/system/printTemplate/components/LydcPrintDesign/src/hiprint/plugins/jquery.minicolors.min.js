...
!(function (i) {
  ...
  function e(i, t) {
    function o(i, t) {
      var o, s;
      return i.length && t
        ? ((o = i.offset().left), (s = i.offset().top), { x: o - t.offset().left + i.outerWidth() / 2, y: s - t.offset().top + i.outerHeight() / 2 })
        : null;
    }
    var s,
      a,
  ...
  function c(t, o) {
    ...
    switch (
      (v(t.val())
        ? ((s = y(t.val())), (r = f(parseFloat(b(t.val())).toFixed(2), 0, 1)), r && t.attr('data-opacity', r))
    ...
    if (!r || r.value !== t || r.opacity !== o) {
      if ((i.data('minicolors-lastChange', { value: t, opacity: o }), e.swatches && 0 !== e.swatches.length)) {
        ...
        i.parent().find('.minicolors-swatches .minicolors-swatch').removeClass('selected'),
          a !== -1 && i.parent().find('.minicolors-swatches .minicolors-swatch').eq(n).addClass('selected');
      }
      e.change &&
        (e.changeDelay
  ...
  function d(t, o) {
    ...
    return s
      ? (void 0 === a && (a = 1), o ? 'rgba(' + s.r + ', ' + s.g + ', ' + s.b + ', ' + parseFloat(a) + ')' : 'rgb(' + s.r + ', ' + s.g + ', ' + s.b + ')')
      : null;
  }
  function p(i, t) {
  ...
  function b(i) {
    return (
      (i = i.match(/^rgba?[\s+]?\([\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+)[\s+]?,[\s+]?(\d+(\.\d{1,2})?|\.\d{1,2})[\s+]?/i)),
      i && 6 === i.length ? i[4] : '1'
    );
  }
  function w(i) {
            ...
            return void 0 === e
              ...
              : (i(this).each(function () {
                  'object' == typeof e && null !== e
                    ? (void 0 !== e.opacity && i(this).attr('data-opacity', f(e.opacity, 0, 1)), e.color && i(this).val(e.color))
                    : i(this).val(e),
                    c(i(this));
                }),
                i(this));
            ...
            : (v(e.val()) ? (s = g(e.val(), !0)) : ((o = u(e.val(), !0)), (s = o ? I(o) : null)),
              (n =
                null === s
                  ? r.defaultValue
                  : 'rgb' === r.format
                  ? g(r.opacity ? 'rgba(' + s.r + ',' + s.g + ',' + s.b + ',' + e.attr('data-opacity') + ')' : 'rgb(' + s.r + ',' + s.g + ',' + s.b + ')')
                  : C(s))),
