...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    (e.MODULO = 103),
      ...
      (e.C_CHARS = '(Ï*[0-9]{2}Ï*)'),
      (e.BARS = [
        11011001100, 11001101100, 11001100110, 10010011e3, 10010001100, 10001001100, 10011001e3, 10011000100, 10001100100, 11001001e3, 11001000100, 11000100100,
        10110011100, 10011011100, 10011001110, 10111001100, 10011101100, 10011100110, 11001110010, 11001011100, 11001001110, 11011100100, 11001110100,
        11101101110, 11101001100, 11100101100, 11100100110, 11101100100, 11100110100, 11100110010, 11011011e3, 11011000110, 11000110110, 10100011e3, 10001011e3,
        10001000110, 10110001e3, 10001101e3, 10001100010, 11010001e3, 11000101e3, 11000100010, 10110111e3, 10110001110, 10001101110, 10111011e3, 10111000110,
        10001110110, 11101110110, 11010001110, 11000101110, 11011101e3, 11011100010, 11011101110, 11101011e3, 11101000110, 11100010110, 11101101e3, 11101100010,
        11100011010, 11101111010, 11001000010, 11110001010, 1010011e4, 10100001100, 1001011e4, 10010000110, 10000101100, 10000100110, 1011001e4, 10110000100,
        1001101e4, 10011000010, 10000110100, 10000110010, 11000010010, 1100101e4, 11110111010, 11000010100, 10001111010, 10100111100, 10010111100, 10010011110,
        10111100100, 10011110100, 10011110010, 11110100100, 11110010100, 11110010010, 11011011110, 11011110110, 11110110110, 10101111e3, 10100011110,
        10001011110, 10111101e3, 10111100010, 11110101e3, 11110100010, 10111011110, 10111101110, 11101011110, 11110101110, 11010000100, 1101001e4, 11010011100,
        1100011101011,
      ]);
  },
  function (t, e, n) {
                ...
                value: function (t, n, r) {
                  ...
                  if (t[0] >= 200) {
                    ...
                    void 0 !== u
                      ...
                      : ((r !== c.SET_A && r !== c.SET_B) ||
                          i !== c.SHIFT ||
                          (t[0] = r === c.SET_A ? (t[0] > 95 ? t[0] - 96 : t[0]) : t[0] < 32 ? t[0] + 96 : t[0]),
                        (o = e.next(t, n + 1, r)));
  ...
  function (t, e, n) {
    ...
    var u = (function (t) {
        function e(t, n) {
          ...
          return (
            (i.name = 'InvalidInputException'), (i.symbology = t), (i.input = n), (i.message = '"' + i.input + '" is not a valid input for ' + i.symbology), i
          );
        }
        return i(e, t), e;
      })(Error),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (
                  ...
                  t.push({ data: '101' + (0, s.default)(this.data[0], 'L'), options: { height: this.guardHeight } }),
                  t.push({ data: (0, s.default)(this.data.substr(1, 5), 'LLLLL'), text: this.text.substr(1, 5), options: { fontSize: this.fontSize } }),
                  t.push({ data: '01010', options: { height: this.guardHeight } }),
                  t.push({ data: (0, s.default)(this.data.substr(6, 5), 'RRRRR'), text: this.text.substr(6, 5), options: { fontSize: this.fontSize } }),
                  t.push({ data: (0, s.default)(this.data[11], 'R') + '101', options: { height: this.guardHeight } }),
  ...
  function (t, e, n) {
    ...
    function o(t) {
      ...
      if (t && 'object' === (void 0 === t ? 'undefined' : a(t)) && !t.nodeName) return { element: t, renderer: l.default.ObjectRenderer };
                ...
                return (
                  this.options.displayValue &&
                    ...
                    this.options.lastChar &&
                      (t.push({ data: '00' }), t.push({ data: '00000', text: this.options.lastChar, options: { fontSize: this.fontSize } }))),
                  t
                );
              },
            },
      ...
      b = (function (t) {
        function e(t, n) {
          ...
          if (((r.isValid = !1), -1 !== t.search(/^[0-9]{6}$/)))
            (r.middleDigits = t), (r.upcA = a(t, '0')), (r.text = n.text || '' + r.upcA[0] + t + r.upcA[r.upcA.length - 1]), (r.isValid = !0);
          else {
            if (-1 === t.search(/^[01][0-9]{7}$/)) return i(r);
            if (((r.middleDigits = t.substring(1, t.length - 1)), (r.upcA = a(r.middleDigits, t[0])), r.upcA[r.upcA.length - 1] !== t[t.length - 1]))
              return i(r);
            r.isValid = !0;
          }
          return (
        ...
        return (
          ...
          f(e, [
            ...
            },
            {
              ...
              value: function () {
                var t = '';
                return (t += '101'), (t += this.encodeMiddleDigits()), (t += '010101'), { data: t, text: this.text };
              },
            },
            {
              key: 'guardedEncoding',
            ...
            },
            {
              ...
              value: function (t, e, n) {
                ...
                for (var i = 0, u = 0, a = 0; a < o.length; a++)
                  (u = a * e.width + n.barcodePadding), '1' === o[a] ? i++ : i > 0 && (this.drawRect(u - e.width * i, r, e.width * i, e.height, t), (i = 0));
