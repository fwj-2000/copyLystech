!(function (t, e) {
...
})('undefined' != typeof window ? window : this, function (u, c) {
  var f,
    m,
    p,
    w = 'undefined' != typeof module && module.exports,
    d = 800,
    y = 600;
  if (w && 'undefined' == typeof window) {
    var t = require('jsdom').jsdom;
    f = t().defaultView;
  } else f = window;
  function v() {
    return w ? new p() : document.createElement('canvas');
  }
  f.DOMParser || (f.DOMParser = require('xmldom').DOMParser);
  var g,
    x = function (t, e, i) {
      if (null != t || null != e || null != i) {
        var n = (function (t) {
          var A = { opts: t, FRAMERATE: 30, MAX_VIRTUAL_PIXELS: 3e4, log: function (t) {} };
          1 == A.opts.log &&
          ...
          (A.init = function (t) {
            ...
            (A.ImagesLoaded = function () {
              for (var t = 0; t < A.Images.length; t++) if (!A.Images[t].loaded) return !1;
              return !0;
            }),
            (A.trim = function (t) {
            ...
            (A.ajax = function (t) {
              return w
                ? null
                : (e = f.XMLHttpRequest ? new f.XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP'))
            ...
            (A.parseXml = function (e) {
              ...
              try {
                var n = new f.DOMParser();
                return n.parseFromString(e, 'image/svg+xml');
              } catch (t) {
                return (n = new f.DOMParser()).parseFromString(e, 'text/xml');
              }
            }),
            ...
            (A.Property.prototype.getEM = function (t) {
              var e = 12,
                i = new A.Property('fontSize', A.Font.Parse(A.ctx.font).fontSize);
          ...
          return (
            ...
            (A.Font = new (function () {
              ...
              this.Parse = function (t) {
                for (
                  var e = {},
                    i = A.trim(A.compressSpaces(t || '')).split(' '),
                    n = { fontSize: !1, fontStyle: !1, fontWeight: !1, fontVariant: !1 },
                    s = '',
                    a = 0;
                  a < i.length;
                  a++
                  ...
                  n.fontStyle || -1 == r.Styles.indexOf(i[a])
                    ? n.fontVariant || -1 == r.Variants.indexOf(i[a])
                      ? n.fontWeight || -1 == r.Weights.indexOf(i[a])
                        ? n.fontSize
                          ? 'inherit' != i[a] && (s += i[a])
                          : ('inherit' != i[a] && (e.fontSize = i[a].split('/')[0]), (n.fontStyle = n.fontVariant = n.fontWeight = n.fontSize = !0))
                        : ('inherit' != i[a] && (e.fontWeight = i[a]), (n.fontStyle = n.fontVariant = n.fontWeight = !0))
                      : ('inherit' != i[a] && (e.fontVariant = i[a]), (n.fontStyle = n.fontVariant = !0))
                    : ('inherit' != i[a] && (e.fontStyle = i[a]), (n.fontStyle = !0));
                return '' != s && (e.fontFamily = s), e;
              };
            })()),
            (A.ToNumberArray = function (t) {
              for (var e = A.trim(A.compressSpaces((t || '').replace(/,/g, ' '))).split(' '), i = 0; i < e.length; i++) e[i] = parseFloat(e[i]);
              return e;
            }),
            ...
            (A.CreatePath = function (t) {
              for (var e = A.ToNumberArray(t), i = [], n = 0; n < e.length; n += 2) i.push(new A.Point(e[n], e[n + 1]));
              return i;
            }),
            (A.BoundingBox = function (t, e, i, n) {
              (this.x1 = Number.NaN),
                ...
                (this.addPoint = function (t, e) {
                  null != t &&
                    ((isNaN(this.x1) || isNaN(this.x2)) && ((this.x1 = t), (this.x2 = t)), t < this.x1 && (this.x1 = t), t > this.x2 && (this.x2 = t)),
                    null != e &&
                      ((isNaN(this.y1) || isNaN(this.y2)) && ((this.y1 = e), (this.y2 = e)), e < this.y1 && (this.y1 = e), e > this.y2 && (this.y2 = e));
                }),
            ...
            (A.Transform = function (t) {
              ...
              (this.Type = {}),
                ...
                (this.Type.rotate = function (t) {
                  var e = A.ToNumberArray(t);
                  (this.angle = new A.Property('angle', e[0])),
                    (this.cx = e[1] || 0),
                    (this.cy = e[2] || 0),
                    (this.apply = function (t) {
              ...
              for (
                var i = A.trim(A.compressSpaces(t))
                    .replace(/\)([a-zA-Z])/g, ') $1')
                    .replace(/\)(\s?,\s?)/g, ') ')
                    .split(/\s(?=[a-z])/),
                  n = 0;
            ...
            (A.AspectRatio = function (t, e, i, n, s, a, r, o, l, h) {
              ...
              'meet' == c && ((n *= p), (a *= p)),
                'slice' == c && ((n *= d), (a *= d)),
                (l = new A.Property('refX', l)),
                (h = new A.Property('refY', h)),
                l.hasValue() && h.hasValue()
                  ? t.translate(-p * l.toPixels('x'), -p * h.toPixels('y'))
                  : (u.match(/^xMid/) && (('meet' == c && p == m) || ('slice' == c && d == m)) && t.translate(i / 2 - n / 2, 0),
                    u.match(/YMid$/) && (('meet' == c && p == f) || ('slice' == c && d == f)) && t.translate(0, s / 2 - a / 2),
                    u.match(/^xMax/) && (('meet' == c && p == m) || ('slice' == c && d == m)) && t.translate(i - n, 0),
                    u.match(/YMax$/) && (('meet' == c && p == f) || ('slice' == c && d == f)) && t.translate(0, s - a)),
                'none' == u ? t.scale(f, m) : 'meet' == c ? t.scale(p, p) : 'slice' == c && t.scale(d, d),
                t.translate(null == r ? 0 : -r, null == o ? 0 : -o);
            }),
            (A.Element = {}),
            (A.EmptyProperty = new A.Property('EMPTY', '')),
            (A.Element.ElementBase = function (a) {
              (this.attributes = {}),
                (this.styles = {}),
              ...
              (this.base = A.Element.ElementBase),
                ...
                (this.setContext = function (t) {
                  ...
                  if (this.style('fill').isUrlDefinition())
                    null != (e = this.style('fill').getFillStyleDefinition(this, this.style('fill-opacity'))) && (t.fillStyle = e);
                  else if (this.style('fill').hasValue()) {
                    var i;
                    'currentColor' == (i = this.style('fill')).value && (i.value = this.style('color').value),
                      'inherit' != i.value && (t.fillStyle = 'none' == i.value ? 'rgba(0,0,0,0)' : i.value);
                  }
                  if (
                    (this.style('fill-opacity').hasValue() &&
                      ((i = (i = new A.Property('fill', t.fillStyle)).addOpacity(this.style('fill-opacity'))), (t.fillStyle = i.value)),
                    this.style('stroke').isUrlDefinition())
                  )
                    null != (e = this.style('stroke').getFillStyleDefinition(this, this.style('stroke-opacity'))) && (t.strokeStyle = e);
                  else if (this.style('stroke').hasValue()) {
                    var n;
                    'currentColor' == (n = this.style('stroke')).value && (n.value = this.style('color').value),
                      'inherit' != n.value && (t.strokeStyle = 'none' == n.value ? 'rgba(0,0,0,0)' : n.value);
                  }
                  if (
                    (this.style('stroke-opacity').hasValue() &&
                      ((n = (n = new A.Property('stroke', t.strokeStyle)).addOpacity(this.style('stroke-opacity'))), (t.strokeStyle = n.value)),
                  ...
                  if (
                    ...
                    var a = A.ToNumberArray(this.style('stroke-dasharray').value);
                    void 0 !== t.setLineDash
                      ? t.setLineDash(a)
                      : void 0 !== t.webkitLineDash
                      ? (t.webkitLineDash = a)
                      : void 0 === t.mozDash || (1 == a.length && 0 == a[0]) || (t.mozDash = a);
                    var r = this.style('stroke-dashoffset').numValueOrDefault(1);
                    void 0 !== t.lineDashOffset
                      ? (t.lineDashOffset = r)
                      : void 0 !== t.webkitLineDashOffset
                      ? (t.webkitLineDashOffset = r)
                      : void 0 !== t.mozDashOffset && (t.mozDashOffset = r);
                  }
                  if (
                    (void 0 !== t.font &&
                      (t.font = A.Font.CreateFont(
                    ...
                    this.style('transform', !1, !0).hasValue() && new A.Transform(this.style('transform', !1, !0).value).apply(t),
                    this.style('clip-path', !1, !0).hasValue())
                  ) {
                    var o = this.style('clip-path', !1, !0).getDefinition();
                    null != o && o.apply(t);
                  }
            ...
            (A.Element.PathElementBase = function (t) {
              (this.base = A.Element.RenderedElementBase),
                ...
                (this.renderChildren = function (t) {
                  ...
                  if (null != e) {
                    if (
                      (this.style('marker-start').isUrlDefinition() && (i = this.style('marker-start').getDefinition()).render(t, e[0][0], e[0][1]),
              ...
              (this.base = A.Element.RenderedElementBase),
                ...
                (this.setContext = function (t) {
                  (t.strokeStyle = 'rgba(0,0,0,0)'),
                    ...
                    (t.lineJoin = 'miter'),
                    (t.miterLimit = 4),
                    t.canvas.style && void 0 !== t.font && void 0 !== f.getComputedStyle && (t.font = f.getComputedStyle(t.canvas).getPropertyValue('font')),
                  ...
                  if (
                    ...
                    this.attribute('refX').hasValue() &&
                      ...
                      ((n = -this.attribute('refX').toPixels('x')), (s = -this.attribute('refY').toPixels('y'))),
                      'visible' != this.attribute('overflow').valueOrDefault('hidden') &&
                        (t.beginPath(), t.moveTo(n, s), t.lineTo(e, s), t.lineTo(e, i), t.lineTo(n, i), t.closePath(), t.clip());
                  }
                  if ((A.ViewPort.SetCurrent(e, i), this.attribute('viewBox').hasValue())) {
                    var a = A.ToNumberArray(this.attribute('viewBox').value),
                      r = a[0],
                      o = a[1];
                    (e = a[2]),
                      (i = a[3]),
            ...
            (A.Element.rect = function (t) {
              (this.base = A.Element.PathElementBase),
                ...
                (this.path = function (t) {
                  ...
                  return (
                    this.attribute('rx').hasValue() && !this.attribute('ry').hasValue() && (r = a),
                    this.attribute('ry').hasValue() && !this.attribute('rx').hasValue() && (a = r),
                    (a = Math.min(a, n / 2)),
                    (r = Math.min(r, s / 2)),
                    null != t &&
                      (t.beginPath(),
                      ...
                      t.lineTo(e + a, i + s),
                      t.quadraticCurveTo(e, i + s, e, i + s - r),
                      t.lineTo(e, i + r),
                      t.quadraticCurveTo(e, i, e + a, i),
                      t.closePath()),
                    new A.BoundingBox(e, i, e + n, i + s)
                  );
                });
            }),
            (A.Element.rect.prototype = new A.Element.PathElementBase()),
            (A.Element.circle = function (t) {
              (this.base = A.Element.PathElementBase),
                this.base(t),
                (this.path = function (t) {
                  ...
                  return null != t && (t.beginPath(), t.arc(e, i, n, 0, 2 * Math.PI, !0), t.closePath()), new A.BoundingBox(e - n, i - n, e + n, i + n);
                });
            }),
            (A.Element.circle.prototype = new A.Element.PathElementBase()),
            (A.Element.ellipse = function (t) {
              (this.base = A.Element.PathElementBase),
                this.base(t),
                (this.path = function (t) {
                  ...
                  return (
                    null != t &&
                      ...
                      t.bezierCurveTo(s - i, a - e * n, s - e * i, a - n, s, a - n),
                      t.closePath()),
                    new A.BoundingBox(s - i, a - n, s + i, a + n)
                  );
                });
            }),
            (A.Element.ellipse.prototype = new A.Element.PathElementBase()),
            (A.Element.line = function (t) {
              (this.base = A.Element.PathElementBase),
                this.base(t),
                (this.getPoints = function () {
                  return [
                    new A.Point(this.attribute('x1').toPixels('x'), this.attribute('y1').toPixels('y')),
                    new A.Point(this.attribute('x2').toPixels('x'), this.attribute('y2').toPixels('y')),
                  ];
                }),
                (this.path = function (t) {
                ...
                (this.path = function (t) {
                  ...
                  for (null != t && t.beginPath(); !e.isEnd(); )
                    switch ((e.nextCommand(), e.command)) {
                      ...
                      case 'v':
                        for (; !e.isCommandOrEnd(); )
                          (a = new A.Point(e.current.x, (e.isRelativeCommand() ? e.current.y : 0) + e.getScalar())),
                        ...
                        for (; !e.isCommandOrEnd(); ) {
                          ...
                          var u = e.getScalar(),
                            ...
                            d =
                              ((h = e.getAsCurrentPoint()),
                              new A.Point(
                                (Math.cos(f) * (r.x - h.x)) / 2 + (Math.sin(f) * (r.y - h.y)) / 2,
                                (-Math.sin(f) * (r.x - h.x)) / 2 + (Math.cos(f) * (r.y - h.y)) / 2,
                              )),
                          ...
                          var v =
                            (m == p ? -1 : 1) *
                            Math.sqrt(
                              (Math.pow(u, 2) * Math.pow(c, 2) - Math.pow(u, 2) * Math.pow(d.y, 2) - Math.pow(c, 2) * Math.pow(d.x, 2)) /
                                (Math.pow(u, 2) * Math.pow(d.y, 2) + Math.pow(c, 2) * Math.pow(d.x, 2)),
                            );
                          isNaN(v) && (v = 0);
              ...
              (this.base = A.Element.ElementBase),
                ...
                (this.createPattern = function (t, e) {
                  var i = this.attribute('width').toPixels('x', !0),
                    ...
                    s = new A.Element.svg();
                  (s.attributes.viewBox = new A.Property('viewBox', this.attribute('viewBox').value)),
                    (s.attributes.width = new A.Property('width', i + 'px')),
                    (s.attributes.height = new A.Property('height', n + 'px')),
                    (s.attributes.transform = new A.Property('transform', this.attribute('patternTransform').value)),
                  ...
                  this.attribute('x').hasValue() &&
                    ...
                    r.translate(this.attribute('x').toPixels('x', !0), this.attribute('y').toPixels('y', !0));
                  for (var o = -1; o <= 1; o++)
                    for (var l = -1; l <= 1; l++)
                      r.save(),
                        (s.attributes.x = new A.Property('x', o * a.width)),
                        (s.attributes.y = new A.Property('y', l * a.height)),
                        s.render(r),
                        r.restore();
              ...
              (this.getGradient = function () {}),
                ...
                (this.createGradient = function (t, e, i) {
                  ...
                  if (this.attribute('gradientTransform').hasValue()) {
                    ...
                    (l.attributes.x = new A.Property('x', -A.MAX_VIRTUAL_PIXELS / 3)),
                      (l.attributes.y = new A.Property('y', -A.MAX_VIRTUAL_PIXELS / 3)),
                      (l.attributes.width = new A.Property('width', A.MAX_VIRTUAL_PIXELS)),
                      (l.attributes.height = new A.Property('height', A.MAX_VIRTUAL_PIXELS));
                    ...
                    (u.attributes.x = new A.Property('x', 0)),
                      (u.attributes.y = new A.Property('y', 0)),
                      (u.attributes.width = new A.Property('width', o.width)),
                      (u.attributes.height = new A.Property('height', o.height)),
                      (u.children = [h]);
                    var c = v();
            ...
            (A.Element.linearGradient = function (t) {
              (this.base = A.Element.GradientBase),
                ...
                (this.getGradient = function (t, e) {
                  ...
                  var n =
                      'objectBoundingBox' == this.gradientUnits() ? i.x() + i.width() * this.attribute('x1').numValue() : this.attribute('x1').toPixels('x'),
            ...
            (A.Element.radialGradient = function (t) {
              (this.base = A.Element.GradientBase),
                this.base(t),
                ...
                (this.getGradient = function (t, e) {
                  ...
                  var n =
                      'objectBoundingBox' == this.gradientUnits() ? i.x() + i.width() * this.attribute('cx').numValue() : this.attribute('cx').toPixels('x'),
                  ...
                  this.attribute('fx').hasValue() &&
                    (a =
                      'objectBoundingBox' == this.gradientUnits() ? i.x() + i.width() * this.attribute('fx').numValue() : this.attribute('fx').toPixels('x')),
            ...
            (A.Element.AnimateBase = function (t) {
              (this.base = A.Element.ElementBase),
                this.base(t),
                ...
                (this.progress = function () {
                  ...
                  if (this.values.hasValue()) {
                    var e = t.progress * (this.values.value.length - 1),
                      i = Math.floor(e),
                      n = Math.ceil(e);
                    (t.from = new A.Property('from', parseFloat(this.values.value[i]))),
                      (t.to = new A.Property('to', parseFloat(this.values.value[n]))),
                      (t.progress = (e - i) / (n - i));
            ...
            (A.Element.animateColor = function (t) {
              (this.base = A.Element.AnimateBase),
                this.base(t),
                (this.calcValue = function () {
                  var t = this.progress(),
                    e = new u(t.from.value),
                    i = new u(t.to.value);
                  if (e.ok && i.ok) {
            ...
            (A.Element.animateTransform = function (t) {
              (this.base = A.Element.AnimateBase),
                this.base(t),
                (this.calcValue = function () {
            ...
            (A.Element.font = function (t) {
              ...
              for (var e = 0; e < this.children.length; e++) {
                var i = this.children[e];
                'font-face' == i.type
                  ? (this.fontFace = i).style('font-family').hasValue() && (A.Definitions[i.style('font-family').value] = this)
              ...
              (this.captureTextNodes = !0),
                ...
                (this.getBoundingBox = function () {
                  var t = this.attribute('x').toPixels('x'),
                    ...
                    i = this.parent.style('font-size').numValueOrDefault(A.Font.Parse(A.ctx.font).fontSize);
                  return new A.BoundingBox(t, e - i, t + Math.floor((2 * i) / 3) * this.children[0].getText().length, e);
                }),
                (this.renderChildren = function (t) {
            ...
            (A.Element.TextElementBase = function (t) {
              (this.base = A.Element.RenderedElementBase),
                this.base(t),
                ...
                (this.renderChildren = function (t) {
                  ...
                  if (null == e)
                    'stroke' == t.paintOrder
                      ? ('' != t.strokeStyle && t.strokeText(A.compressSpaces(this.getText()), this.x, this.y),
                        '' != t.fillStyle && t.fillText(A.compressSpaces(this.getText()), this.x, this.y))
                      : ('' != t.fillStyle && t.fillText(A.compressSpaces(this.getText()), this.x, this.y),
                        '' != t.strokeStyle && t.strokeText(A.compressSpaces(this.getText()), this.x, this.y));
                  else {
            ...
            (A.Element.a = function (t) {
              ...
              (this.text = this.hasText ? t.childNodes[0].value || t.childNodes[0].data : ''),
                ...
                (this.onclick = function () {
                  f.open(this.getHrefAttribute().value);
                }),
            ...
            (A.Element.image = function (t) {
              (this.base = A.Element.RenderedElementBase), this.base(t);
              var e = this.getHrefAttribute().value;
              if ('' != e) {
                var a = e.match(/\.svg$/);
                if ((A.Images.push(this), (this.loaded = !1), a)) (this.img = A.ajax(e)), (this.loaded = !0);
                else {
                  (this.img = w ? new m() : document.createElement('img')), 1 == A.opts.useCORS && (this.img.crossOrigin = 'Anonymous');
                  var r = this;
                ...
                (this.renderChildren = function (t) {
                  ...
                  0 != n &&
                    ...
                    a
                      ...
                      : (t.translate(e, i),
                        A.AspectRatio(t, this.attribute('preserveAspectRatio').value, n, this.img.width, s, this.img.height, 0, 0),
            ...
            (A.Element.g = function (t) {
              (this.base = A.Element.RenderedElementBase),
                this.base(t),
                (this.getBoundingBox = function () {
                  for (var t = new A.BoundingBox(), e = 0; e < this.children.length; e++) t.addBoundingBox(this.children[e].getBoundingBox());
                  return t;
                });
            }),
            (A.Element.g.prototype = new A.Element.RenderedElementBase()),
            (A.Element.symbol = function (t) {
                ...
                if ('' != A.trim(n[i]))
                  for (var s = n[i].split('{'), a = s[0].split(','), r = s[1].split(';'), o = 0; o < a.length; o++) {
                    ...
                    if ('' != l) {
                      ...
                      if (((A.Styles[l] = h), (A.StylesSpecificity[l] = B(l)), '@font-face' == l && !w))
                        for (var p = h['font-family'].value.replace(/"/g, ''), d = h.src.value.split(','), y = 0; y < d.length; y++)
                          if (0 < d[y].indexOf('format("svg")'))
                            for (
                              var v = d[y].indexOf('url'),
                                g = d[y].indexOf(')', v),
                                x = d[y].substr(v + 5, g - v - 6),
                                b = A.parseXml(A.ajax(x)).getElementsByTagName('font'),
                                P = 0;
                              P < b.length;
                              P++
                            ) {
              ...
              (this.path = function (t) {
                ...
                (this.renderChildren = function (t) {
                  if (null != n) {
                    var e = n;
                    'symbol' == n.type &&
                      (((e = new A.Element.svg()).type = 'svg'),
                      (e.attributes.viewBox = new A.Property('viewBox', n.attribute('viewBox').value)),
                      (e.attributes.preserveAspectRatio = new A.Property('preserveAspectRatio', n.attribute('preserveAspectRatio').value)),
                      (e.attributes.overflow = new A.Property('overflow', n.attribute('overflow').value)),
                      (e.children = n.children)),
                      'svg' == e.type &&
                        (this.attribute('width').hasValue() && (e.attributes.width = new A.Property('width', this.attribute('width').value)),
                        this.attribute('height').hasValue() && (e.attributes.height = new A.Property('height', this.attribute('height').value)));
                    var i = e.parent;
            ...
            (A.Element.mask = function (t) {
              (this.base = A.Element.ElementBase),
                ...
                (this.apply = function (t, e) {
                  ...
                  if (0 == s && 0 == a) {
                    for (var r = new A.BoundingBox(), o = 0; o < this.children.length; o++) r.addBoundingBox(this.children[o].getBoundingBox());
              ...
              (this.base = A.Element.ElementBase),
                ...
                (this.apply = function (t) {
                  var e = 'undefined' != typeof CanvasRenderingContext2D,
                    i = t.beginPath,
                    n = t.closePath;
                  e && ((CanvasRenderingContext2D.prototype.beginPath = function () {}), (CanvasRenderingContext2D.prototype.closePath = function () {})),
                    i.call(t);
                  for (var s = 0; s < this.children.length; s++) {
                    var a = this.children[s];
                    if (void 0 !== a.path) {
                      var r = null;
                      a.style('transform', !1, !0).hasValue() && (r = new A.Transform(a.style('transform', !1, !0).value)).apply(t),
                        a.path(t),
            ...
            (A.Element.feMorphology = function (t) {
            ...
            (A.Element.feComposite = function (t) {
              (this.base = A.Element.ElementBase), this.base(t), (this.apply = function (t, e, i, n, s) {});
            }),
            (A.Element.feComposite.prototype = new A.Element.ElementBase()),
            (A.Element.feColorMatrix = function (t) {
              (this.base = A.Element.ElementBase), this.base(t);
              ...
              this.apply = function (t, e, i, n, s) {
                ...
                for (i = 0; i < s; i++)
                  for (e = 0; e < n; e++) {
                    ...
                    c(a.data, e, i, n, 0, 0, f(0, r) + f(1, o) + f(2, l) + f(3, h) + f(4, 1)),
                      c(a.data, e, i, n, 0, 1, f(5, r) + f(6, o) + f(7, l) + f(8, h) + f(9, 1)),
                      c(a.data, e, i, n, 0, 2, f(10, r) + f(11, o) + f(12, l) + f(13, h) + f(14, 1)),
                      c(a.data, e, i, n, 0, 3, f(15, r) + f(16, o) + f(17, l) + f(18, h) + f(19, 1));
                  }
                t.clearRect(0, 0, n, s), t.putImageData(a, 0, 0);
              };
            }),
            (A.Element.feColorMatrix.prototype = new A.Element.ElementBase()),
            (A.Element.feGaussianBlur = function (t) {
              (this.base = A.Element.ElementBase),
                this.base(t),
            ...
            (A.loadXmlDoc = function (a, r) {
              ...
              var i = function (t) {
                ...
                return f.scrollX && (t.x += f.scrollX), f.scrollY && (t.y += f.scrollY), t;
              };
              1 != A.opts.ignoreMouse &&
              ...
              var l = !0,
                n = function () {
                  A.ViewPort.Clear(),
                    a.canvas.parentNode
                      ? A.ViewPort.SetCurrent(a.canvas.parentNode.clientWidth, a.canvas.parentNode.clientHeight)
                      : A.ViewPort.SetCurrent(d, y),
                    1 != A.opts.ignoreDimensions &&
                      (o.style('width').hasValue() &&
                        ((a.canvas.width = o.style('width').toPixels('x')), a.canvas.style && (a.canvas.style.width = a.canvas.width + 'px')),
                      o.style('height').hasValue() &&
                        ((a.canvas.height = o.style('height').toPixels('y')), a.canvas.style && (a.canvas.style.height = a.canvas.height + 'px')));
                  ...
                  if (
                    (1 == A.opts.ignoreDimensions &&
                      o.style('width').hasValue() &&
                      o.style('height').hasValue() &&
                      ((t = o.style('width').toPixels('x')), (e = o.style('height').toPixels('y'))),
                    A.ViewPort.SetCurrent(t, e),
                    null != A.opts.offsetX && (o.attribute('x', !0).value = A.opts.offsetX),
                    null != A.opts.offsetY && (o.attribute('y', !0).value = A.opts.offsetY),
                    null != A.opts.scaleWidth || null != A.opts.scaleHeight)
                  ) {
                    var i = null,
                      n = null,
                      s = A.ToNumberArray(o.attribute('viewBox').value);
                    null != A.opts.scaleWidth &&
                      (o.attribute('width').hasValue()
                        ? (i = o.attribute('width').toPixels('x') / A.opts.scaleWidth)
                        : isNaN(s[2]) || (i = s[2] / A.opts.scaleWidth)),
                      null != A.opts.scaleHeight &&
                        (o.attribute('height').hasValue()
                          ? (n = o.attribute('height').toPixels('y') / A.opts.scaleHeight)
                          : isNaN(s[3]) || (n = s[3] / A.opts.scaleHeight)),
                      null == i && (i = n),
                      null == n && (n = i),
                      (o.attribute('width', !0).value = A.opts.scaleWidth),
                      (o.attribute('height', !0).value = A.opts.scaleHeight),
                      (o.style('transform', !0, !0).value += ' scale(' + 1 / i + ',' + 1 / n + ')');
                  }
                  1 != A.opts.ignoreClear && a.clearRect(0, 0, t, e),
                    o.render(a),
                    l && ((l = !1), 'function' == typeof A.opts.renderCallback && A.opts.renderCallback(r));
                },
                s = !0;
              A.ImagesLoaded() && ((s = !1), n()),
                (w && !t.enableRedraw) ||
                  (A.intervalID = setInterval(function () {
                    var t = !1;
                    if ((s && A.ImagesLoaded() && ((s = !1), (t = !0)), 1 != A.opts.ignoreMouse && (t |= A.Mouse.hasEvents()), 1 != A.opts.ignoreAnimation))
                      for (var e = 0; e < A.Animations.length; e++) t |= A.Animations[e].update(1e3 / A.FRAMERATE);
        ...
        if (w) {
          if (!e || '' === e) return;
          return (m = i.ImageClass), (p = t.constructor), void n.loadXml(t.getContext('2d'), e);
        }
        ...
        for (var a = document.querySelectorAll('svg'), r = 0; r < a.length; r++) {
          ...
          h.appendChild(o), x(l, h.innerHTML);
        }
    };
  w
    ? (g = function (t, e) {
    ...
    : 'undefined' == typeof Element ||
      (void 0 !== Element.prototype.matches
        ...
        : (('function' != typeof jQuery && 'function' != typeof Zepto) ||
          ...
          void 0 === g && 'undefined' != typeof Sizzle && (g = Sizzle.matchesSelector)));
  var e = /(\[[^\]]+\])/g,
    i = /(#[^\s\+>~\.\[:]+)/g,
    a = /(\.[^\s\+>~\.\[:]+)/g,
  ...
  function B(n) {
    ...
    return (
      (n = (n = n.replace(/:not\(([^\)]*)\)/g, '     $1 ')).replace(/{[\s\S]*/gm, ' ')),
      t(e, 1),
      t(i, 0),
      t(a, 1),
      t(r, 2),
  ...
  return (
    'undefined' != typeof CanvasRenderingContext2D &&
      (CanvasRenderingContext2D.prototype.drawSvg = function (t, e, i, n, s, a) {
        var r = { ignoreMouse: !0, ignoreAnimation: !0, ignoreDimensions: !0, ignoreClear: !0, offsetX: e, offsetY: i, scaleWidth: n, scaleHeight: s };
