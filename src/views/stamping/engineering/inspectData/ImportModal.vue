      ...
      <div class="upload">
        ...
        <div class="up_right">
          ...
          <a-row>
            ...
            <a-col :span="12">
              <a-button class="ml-10px" :disabled="!state.productCode" type="link" @click="handleTemplateDownload()">{{ t('common.exportTemplate') }}</a-button>
            </a-col>
          </a-row>
        </div>
      </div>
...
<script lang="ts" setup>
  ...
  function handleTemplateDownload() {
    downloadInspectImportTemplate({ productCode: state.productCode }).then(res => {
