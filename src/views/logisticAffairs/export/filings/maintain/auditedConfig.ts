...
export const statusOptions = [{ id: 3, fullName: t('dict.FilingsApplyStatusEnum.3'), theme: 'green' }];
...
export function getFormConfig() {
  return [
    ...
    },
    {
      ...
      component: 'CustomUserSelect',
      componentProps: { placeholder: '复核人', allowClear: true },
    },
    // {
    //   fieldName: 'status',
    //   label: '',
