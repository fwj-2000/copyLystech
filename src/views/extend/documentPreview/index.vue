<template>
  <div class="lydc-content-wrapper documentPreview-wrapper">
    <div class="lydc-content-wrapper-center">
      ...
      <div class="lydc-content-wrapper-content bg-white">
        <a-tabs v-model:activeKey="activeKey" type="card" class="lydc-content-wrapper-tabs" destroyInactiveTabPane>
        ...
        <div class="p-10px">
          ...
          <a-alert message="永中文档预览组件是付费组件" type="warning" show-icon v-else />
        </div>
...
<style lang="less" scoped>
  .documentPreview-wrapper {
    &.lydc-content-wrapper .lydc-content-wrapper-center .lydc-content-wrapper-content {
      .lydc-content-wrapper-tabs.ant-tabs-card {
        height: auto;
      }
    }
  }
