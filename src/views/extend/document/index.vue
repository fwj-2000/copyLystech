<template>
  <div class="lydc-content-wrapper document-wrapper bg-white">
    <a-tabs v-model:activeKey="activeKey" tab-position="left" class="common-left-tabs">
      <a-tab-pane key="all">
        ...
        <div class="container">
          ...
          <div class="lydc-common-search-box">
...
<script lang="ts" setup>
  ...
  import { toFileSize } from '/@/utils/lydc';
...
<style lang="less" scoped>
  .document-wrapper {
    ...
    .lydc-common-search-box {
      padding-left: 10px;
      margin-bottom: 10px;

      .lydc-common-search-box-right {
        right: 0;
        top: 10px;
      }
    }
