      ...
      <ScrollContainer>
        ...
        <a-form ref="formRef" :colon="false" :model="dataForm" :labelCol="{ style: { width: '110px' } }">
          ...
          <a-form-item label="生产日期">
            <lydc-date-picker v-model:value="dataForm.ProductionDate" format="YYYY-MM-DD" allowClear />
          </a-form-item>
          <a-form-item label="回款日期">
            <lydc-date-picker v-model:value="dataForm.ReturnMoneyDate" format="YYYY-MM-DD HH:mm:ss" allowClear />
          </a-form-item>
          <a-form-item label="计划执行日期">
            <lydc-date-picker v-model:value="dataForm.PlanExecutionDate" format="YYYY-MM-DD HH:mm:ss" allowClear />
          </a-form-item>
          <a-form-item label="统计月份">
            <lydc-date-picker v-model:value="dataForm.StatisticalMonth" format="YYYY-MM" allowClear />
          </a-form-item>
          <a-form-item label="规划日期">
            <lydc-date-picker v-model:value="dataForm.Programme" format="YYYY-MM-DD" allowClear />
          </a-form-item>
          <a-form-item label="规划日期">
            <lydc-date-range v-model:value="dataForm.Dates" format="YYYY-MM-DD HH:mm:ss" allowClear />
          </a-form-item>
        </a-form>
      </ScrollContainer>
    </div>
