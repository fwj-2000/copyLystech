<template>
  <div class="lydc-content-wrapper lydc-content-wrapper-form">
    <div class="lydc-content-wrapper-form-body px-10px">
      <ScrollContainer>
        <div class="my-10px">
        ...
        <a-form ref="formRef" :colon="false" :model="dataForm" :labelCol="{ style: { width: '110px' } }">
          ...
          <a-form-item label="角色类型">
            <lydc-select v-model:value="dataForm.RoleType" :options="options" />
          </a-form-item>
          <a-form-item label="树形下拉框">
            <lydc-tree-select v-model:value="dataForm.parentId" :options="treeData" allowClear @change="getValue" />
          </a-form-item>
          <a-form-item label="级联选择器">
            <lydc-cascader v-model:value="dataForm.cascader" placeholder="请选择" :options="options1" allowClear />
          </a-form-item>
          <a-form-item label="用户下拉选择">
            <lydc-custom-user-select v-model:value="dataForm.userId" :label="dataForm.fullName" placeholder="请选择" :allowClear="true" show-search>
            </lydc-custom-user-select>
            <a-button @click="changeUser">更换用户</a-button>
          </a-form-item>
        </a-form>
      </ScrollContainer>
    </div>
...
<script lang="ts" setup>
  ...
  async function init() {
    ...
    state.dataForm.userId = '577692255289081797';
    state.dataForm.fullName = '测试姓名';
  ...
  function changeUser() {
    state.dataForm.userId = '577692273240702917';
