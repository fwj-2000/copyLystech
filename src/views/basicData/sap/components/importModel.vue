...
<script lang="ts" setup>
  ...
  import { templateDownload, importPreview, importData } from '/@/api/basicData/sap';
  ...
  const tableData = [
    // 工厂编码
    { title: t('dict.FactorySapColumn.factoryCode'), dataIndex: 'factoryCode', key: 'factoryCode', width: 150 },
    // 工厂类型
    { title: t('dict.FactorySapColumn.type'), dataIndex: 'type', key: 'type', width: 150 },
    // 业务类型
    { title: t('dict.FactorySapColumn.materialType'), dataIndex: 'materialTypeName', key: 'materialTypeName', width: 150 },
    // SAP代码
    { title: t('dict.FactorySapColumn.code'), dataIndex: 'code', key: 'code', width: 150 },
    // 备注
    { title: t('dict.FactorySapColumn.remark'), dataIndex: 'remark', key: 'remark', width: 150 },
  ];
  const columns: any[] = [
    // 序号
