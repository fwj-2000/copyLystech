...
<script lang="ts" setup>
  ...
  import { templateDownload, importPreview, importData } from '/@/api/basicData/unit';
  ...
  const { t } = useI18n();
  const tableData = [
    { title: t('sys.errorLog.tableColumnMsg'), dataIndex: 'ImportError', key: 'ImportError', width: 70 },
    { title: t('dict.UnitColumn.Code'), dataIndex: 'Code', key: 'Code', width: 50 },
    { title: t('dict.UnitColumn.Name'), dataIndex: 'Name', key: 'Name', width: 50 },
    { title: t('dict.UnitColumn.Auxiliary'), dataIndex: 'Auxiliary', key: 'Auxiliary', width: 50 },
    { title: t('dict.UnitColumn.Conversion'), dataIndex: 'Conversion', key: 'Conversion', width: 50 },
    { title: t('dict.UnitColumn.StatusName'), dataIndex: 'StatusName', key: 'StatusName', width: 50 },
    { title: t('dict.UnitColumn.DotNumber'), dataIndex: 'DotNumber', key: 'DotNumber', width: 50 },
    { title: t('dict.UnitColumn.Remark'), dataIndex: 'Remark', key: 'Remark', width: 50 },
  ];
  const columns: any[] = [
  ...
  const getAction = computed(() => globSetting.apiUrl + '/api/baseData/factorysap/uploader');
