...
<script lang="ts" setup>
  ...
  import { exportHarhorExcel } from '/@/api/basicData/harhor';
  ...
  const columnList = ref<any[]>([
    { fullName: t('dict.HarhorColumn.Name'), id: 'Name' },
    { fullName: t('dict.HarhorColumn.OrgName'), id: 'OrgName' },
    { fullName: t('dict.HarhorColumn.StatusName'), id: 'StatusName' },
    { fullName: t('dict.HarhorColumn.CreatorUserName'), id: 'CreatorUserName' },
    { fullName: t('dict.HarhorColumn.CreatorTime'), id: 'CreatorTime' },
    { fullName: t('dict.HarhorColumn.LastModifyUserName'), id: 'LastModifyUserName' },
    { fullName: t('dict.HarhorColumn.LastModifyTime'), id: 'LastModifyTime' },
    { fullName: t('dict.HarhorColumn.Remark'), id: 'Remark' },
  ]);
