...
<script lang="ts" setup>
  ...
  import { templateDownload, importPreview, importData } from '/@/api/basicData/currency';
  ...
  const tableData = [
    ...
    { title: t('dict.CurrencyColumn.ISOCode'), dataIndex: 'ISOCode', key: 'ISOCode', width: 50 },
    { title: t('dict.CurrencyColumn.ShortName'), dataIndex: 'ShortName', key: 'ShortName', width: 50 },
    { title: t('dict.CurrencyColumn.FullName'), dataIndex: 'FullName', key: 'FullName', width: 50 },
    { title: t('dict.CurrencyColumn.StatusName'), dataIndex: 'StatusName', key: 'StatusName', width: 50 },
    { title: t('dict.CurrencyColumn.Remark'), dataIndex: 'Remark', key: 'Remark', width: 50 },
  ];
  const columns: any[] = [
