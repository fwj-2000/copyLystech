...
<script lang="ts" setup>
  ...
  import { templateDownload, importPreview, importData } from '/@/api/basicData/department';
  ...
  const tableData = [
    ...
    { title: '部门编码', dataIndex: 'Code', key: 'Code', width: 50 },
    { title: '部门名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: '所属厂区', dataIndex: 'FactoryAreaName', key: 'FactoryAreaName', width: 50 },
    { title: '责任人', dataIndex: 'DutyUserName', key: 'DutyUserName', width: 50 },
