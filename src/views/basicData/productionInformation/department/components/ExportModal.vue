...
<script lang="ts" setup>
  ...
  import { exportDepartmentExcel } from '/@/api/basicData/department';
  ...
  const columnList = ref<any[]>([
    { fullName: '部门编码', id: 'Code' },
    { fullName: '部门名称', id: 'Name' },
    { fullName: '所属厂区', id: 'FactoryAreaName' },
