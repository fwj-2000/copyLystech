...
<script lang="ts" setup>
  ...
  import { templateDownload, importPreview, importData } from '/@/api/basicData/factory';
  ...
  const tableData = [
    ...
    { title: '编码', dataIndex: 'Code', key: 'Code', width: 50 },
    { title: '名称', dataIndex: 'Name', key: 'Name', width: 50 },
    { title: 'SAP工厂编码', dataIndex: 'SAPFactoryCodeTitle', key: 'SAPFactoryCodeTitle', width: 50 },
    { title: 'SAP工厂名称', dataIndex: 'SAPFactoryNameTitle', key: 'SAPFactoryNameTitle', width: 50 },
    { title: '主要制程', dataIndex: 'MainProcessTitle', key: 'MainProcessTitle', width: 50 },
    { title: '厂区', dataIndex: 'FactoryArea', key: 'FactoryArea', width: 50 },
