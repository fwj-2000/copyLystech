...
<script lang="ts" setup>
  ...
  import { exportFactoryExcel } from '/@/api/basicData/factory';
  ...
  const columnList = ref<any[]>([
    { fullName: '工厂代码', id: 'Code' },
    { fullName: '工厂名称', id: 'Name' },
    { fullName: 'SAP工厂代码', id: 'SAPFactoryCodeTitle' },
    { fullName: 'SAP工厂名称', id: 'SAPFactoryNameTitle' },
    { fullName: '主要制程', id: 'MainProcessTitle' },
    { fullName: '厂区', id: 'FactoryArea' },
