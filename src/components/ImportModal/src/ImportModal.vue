<template>
  <BasicPopup
    ...
    <template #insertToolbar>
      <a-button v-if="state.pollingParams.interval" @click="handleBack" type="primary">{{ t('common.clearData') }}</a-button>
    </template>
    <ScrollContainer>
      <uploadExcelData
        class="h-full"
...
<script lang="ts" setup>
  import { h, nextTick, onMounted, reactive, ref, toRefs, watch } from 'vue';
