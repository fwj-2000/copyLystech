<template>
  <a-collapse-panel>
    ...
    <template v-if="activeData.option.seriesLabelShow">
      <template v-if="activeData.lydcKey == 'pieChart' && showType == 'pc'">
      ...
      <a-form-item label="字体颜色">
        <lydc-color-picker v-model:value="activeData.option.seriesLabelColor" size="small" />
      </a-form-item>
      <a-form-item label="背景色" v-if="showType == 'pc'">
        <lydc-color-picker v-model:value="activeData.option.seriesLabelBgColor" size="small" />
      </a-form-item>
    </template>
  </a-collapse-panel>
</template>
