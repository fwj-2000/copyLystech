  ...
  <a-collapse-panel>
    ...
    <template v-if="activeData.option.yAxisShow">
      <a-form-item label="坐标轴颜色">
        <lydc-color-picker v-model:value="activeData.option.yAxisAxisLineLineStyleColor" size="small" />
      </a-form-item>
      <template v-if="showType == 'pc'">
        <a-form-item label="Y轴名称">
          <a-input v-model:value="activeData.option.yAxisName" placeholder="请输入" />
        </a-form-item>
        ...
        <a-form-item label="字体颜色">
          <lydc-color-picker v-model:value="activeData.option.yAxisNameTextStyleColor" size="small" />
        </a-form-item>
      ...
      <a-form-item label="标签颜色">
        <lydc-color-picker v-model:value="activeData.option.yAxisAxisLabelTextStyleColor" size="small" />
      </a-form-item>
      ...
      <a-form-item label="网格线颜色" v-if="activeData.option.yAxisSplitLineShow">
        <lydc-color-picker v-model:value="activeData.option.yAxisSplitLineLineStyleColor" size="small" />
      </a-form-item>
    </template>
