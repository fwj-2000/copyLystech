<template>
  <a-collapse-panel>
    ...
    <a-form-item label="副标题名称">
      <a-input v-model:value="activeData.option.titleSubtext" placeholder="请输入" />
    </a-form-item>
    ...
    <a-form-item label="字体颜色">
      <lydc-color-picker v-model:value="activeData.option.titleSubtextStyleColor" size="small" />
    </a-form-item>
  </a-collapse-panel>
</template>
