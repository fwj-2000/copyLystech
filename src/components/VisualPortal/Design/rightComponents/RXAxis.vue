<template>
  <a-collapse-panel>
    ...
    <a-form-item label="坐标轴类型" v-show="showType == 'pc'">
      <lydc-radio v-model:value="activeData.option.category" :options="categoryList" optionType="button" button-style="solid" class="right-radio" />
    </a-form-item>
    ...
    <template v-if="activeData.option.xAxisShow">
      <a-form-item label="坐标轴颜色">
        <lydc-color-picker v-model:value="activeData.option.xAxisAxisLineLineStyleColor" size="small" />
      </a-form-item>
      <template v-if="showType == 'pc'">
        <a-form-item label="X轴名称">
          <a-input v-model:value="activeData.option.xAxisName" placeholder="请输入" />
        </a-form-item>
        ...
        <a-form-item label="字体颜色">
          <lydc-color-picker v-model:value="activeData.option.xAxisNameTextStyleColor" size="small" />
        </a-form-item>
      ...
      <a-form-item label="标签颜色">
        <lydc-color-picker v-model:value="activeData.option.xAxisAxisLabelTextStyleColor" size="small" />
      </a-form-item>
      ...
      <a-form-item label="网格线颜色" v-if="activeData.option.xAxisSplitLineShow">
        <lydc-color-picker v-model:value="activeData.option.xAxisSplitLineLineStyleColor" size="small" />
      </a-form-item>
    </template>
