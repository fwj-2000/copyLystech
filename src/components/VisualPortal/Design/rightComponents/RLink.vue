    ...
    <template v-if="showType == 'pc'">
      ...
      <a-form-item v-if="activeData.option.linkType == 2">
        ...
        <a-input v-model:value="activeData.option.urlAddress" placeholder="请输入">
          <template #addonAfter>
            <lydc-select v-model:value="activeData.option.linkTarget" :options="typeList" class="w-90px" />
          </template>
        </a-input>
      </a-form-item>
    </template>
    ...
    <template v-if="showType == 'pc'">
      ...
      <a-form-item v-if="activeData.card.linkType == 2">
        ...
        <a-input v-model:value="activeData.card.urlAddress" placeholder="请输入">
          <template #addonAfter>
            <lydc-select v-model:value="activeData.card.linkTarget" :options="typeList" class="w-90px" />
          </template>
        </a-input>
      </a-form-item>
    </template>
