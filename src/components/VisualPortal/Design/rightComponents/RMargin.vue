<template>
  <a-collapse-panel>
    ...
    <template v-if="activeData.lydcKey == 'pieChart' || activeData.lydcKey == 'mapChart'">
    ...
    <template v-else-if="activeData.lydcKey == 'radarChart'">
      <a-form-item label="上下边距">
...
<script lang="ts" setup>
  ...
  function getTitle() {
    ...
    if (lydcKey == 'pieChart' || lydcKey == 'radarChart' || lydcKey == 'mapChart') return '中心坐标设置';
    return '坐标轴边距设置';
  }
</script>
