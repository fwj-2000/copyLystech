<template>
  <div>
    ...
    <a-form-item label="背景色">
      <lydc-color-picker v-model:value="activeData.option.bgColor" size="small" />
    </a-form-item>
    <a-form-item label="区域颜色">
      <lydc-color-picker v-model:value="activeData.option.geoAreaColor" size="small" />
    </a-form-item>
    ...
    <template v-if="activeData.option.geoLabelShow">
      ...
      <a-form-item label="字体颜色">
        <lydc-color-picker v-model:value="activeData.option.geoLabelColor" size="small" />
      </a-form-item>
    </template>
    ...
    <a-form-item label="区域线颜色">
      <lydc-color-picker v-model:value="activeData.option.geoBorderColor" size="small" />
    </a-form-item>
    <template v-if="showType == 'pc'">
      ...
      <a-form-item label="阴影颜色">
        <lydc-color-picker v-model:value="activeData.option.geoShadowColor" size="small" />
      </a-form-item>
    ...
    <template v-if="activeData.option.drillDown">
      ...
      <a-form-item label="字体颜色">
        <lydc-color-picker v-model:value="activeData.option.drillDownColor" size="small" />
      </a-form-item>
    </template>
    <template v-if="showType == 'pc'">
      <a-divider>视觉设置</a-divider>
      <a-form-item label="视觉类型">
        <lydc-radio v-model:value="activeData.option.visualMapType" :options="visualMapTypeList" optionType="button" button-style="solid" class="right-radio" />
      </a-form-item>
    ...
    <template v-if="activeData.option.styleType == 1 || activeData.option.styleType == 4">
      ...
      <a-form-item label="散点类型" v-show="showType == 'pc'">
        <lydc-radio v-model:value="activeData.option.seriesType" :options="seriesTypeList" optionType="button" button-style="solid" class="right-radio" />
      </a-form-item>
      <a-form-item>
    ...
    <template v-if="activeData.option.styleType == 4 && showType == 'pc'">
      ...
      <a-form-item label="字体颜色">
        <lydc-color-picker v-model:value="activeData.option.barTitleTextStyleColor" size="small" />
      </a-form-item>
