...
export const basicComponents = [
      ...
      appDefaultValue: [
        {
          ...
          moduleId: '',
          linkType: '2',
          urlAddress: 'https://www.lingyiitech.com/',
          linkTarget: '_blank',
          icon: 'icon-ym icon-ym-webDesign',
          iconBgColor: '#33B932',
          type: 2,
  ...
  },
  {
    ...
    option: {
      styleType: 2,
      defaultValue: '',
      textDefaultValue: 'DC Manage System',
      textFontSize: 14,
      textFontColor: '#fff',
      textFontWeight: false,
      textFontStyle: false,
  ...
  },
  {
    ...
    option: {
      ...
      defaultValue: [
        {
          imageUrl: 'https://app.cdn.lydcsoft.com/image/3.2/banner1.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
        ...
        {
          imageUrl: 'https://app.cdn.lydcsoft.com/image/3.2/banner2.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
        ...
        {
          imageUrl: 'https://app.cdn.lydcsoft.com/image/3.2/banner4.png',
          dataType: 2,
          propsApi: '',
          moduleId: '',
          linkType: '',
  ...
  },
  {
    ...
    option: {
      defaultValue: 'https://www.lingyiitech.com/',
    },
    w: 12,
    h: 8,
    minW: 4,
