...
<script lang="ts" setup>
  ...
  const componentsList = [
    { label: '布局控件', lydcKey: 'layout', icon: 'icon-ym icon-ym-generator-function', list: layoutComponents },
    { label: '基础控件', lydcKey: 'basic', icon: 'icon-ym icon-ym-tree-department', list: basicComponents },
    { label: '系统控件', lydcKey: 'system', icon: 'icon-ym icon-ym-tree-user2', list: systemComponents },
    { label: '图表控件', lydcKey: 'chart', icon: 'icon-ym icon-ym-file-photo', list: chartComponents },
  ];
