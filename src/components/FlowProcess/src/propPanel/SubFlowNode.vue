    ...
    <ScrollContainer class="config-content">
      <a-form :colon="false" layout="vertical" :model="formConf" class="config-form" v-show="activeKey === '1'">
        ...
        <a-form-item label="发起设置">
          <lydc-radio v-model:value="formConf.initiateType" :options="typeOptions" class="type-radio" @change="formConf.initiator = []" />
          ...
          <a-form-item label="表单字段" class="!mb-0" v-if="formConf.initiateType === 4">
            <a-input-group compact>
              ...
              <lydc-select v-model:value="formConf.formField" placeholder="请选择" :options="childFieldOptions" showSearch style="width: calc(100% - 100px)" />
            </a-input-group>
          </a-form-item>
      ...
      <div v-show="activeKey === '2'">
        ...
        <a-form :colon="false" :model="formConf" layout="vertical" class="config-form">
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.launchMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
...
<script lang="ts" setup>
  ...
  function getSubFlowFormInfo(flowId) {
    ...
    getFlowFormInfo(flowId).then(res => {
      ...
      fieldOptions = props.transformFieldList(fieldList).filter(o => o.__config__.lydcKey !== 'table');
