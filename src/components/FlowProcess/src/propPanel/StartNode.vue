    ...
    <ScrollContainer class="config-content" v-show="activeKey !== '3'">
      <a-form :colon="false" layout="vertical" :model="formConf" class="config-form" v-show="activeKey === '1'">
        ...
        <a-form-item v-if="flowType != 1">
          ...
          <lydc-users-select v-model:value="formConf.initiator" buttonType="button" modalTitle="添加发起人" multiple @labelChange="onLabelChange" />
        </a-form-item>
        <a-form-item label="抄送设置">
          ...
          <a-form-item class="!pt-10px">
            ...
            <lydc-select v-model:value="formConf.extraCopyRule" :options="extraRuleOptions" />
          </a-form-item>
      ...
      <div v-show="activeKey === '2'">
        <a-form :colon="false" layout="vertical" :model="formConf" class="config-form">
          ...
          <a-form-item label="标题设置">
            <lydc-radio v-model:value="formConf.titleType" :options="titleTypeOptions" />
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.errorRule" :options="errorRuleOptions" @change="formConf.errorRuleUser = []" />
            <lydc-user-select v-model:value="formConf.errorRuleUser" buttonType="button" multiple class="mt-10px" v-if="formConf.errorRule === 2" />
          </a-form-item>
          <a-form-item label="撤回后处理规则">
            <lydc-select v-model:value="formConf.revokeRule" :options="revokeRuleOptions" />
          </a-form-item>
          <a-form-item label="复活取值规则">
            <lydc-select v-model:value="formConf.resurgenceDataRule" :options="resurgenceDataRuleOptions" />
          </a-form-item>
        </a-form>
      ...
      <div v-show="activeKey === '4'">
        <a-form :colon="false" :model="formConf" labelAlign="left" :labelCol="{ style: { width: '70px' } }" class="config-form">
          ...
          <a-form-item label="">
            <lydc-select v-model:value="formConf.funcConfigRule" :options="funcConfigOptions" />
          </a-form-item>
      ...
      <div v-show="activeKey === '5'">
        ...
        <a-form :colon="false" :model="formConf" layout="vertical" class="config-form">
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.waitMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.endMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.approveMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.rejectMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.copyMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.overTimeMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.noticeMsgConfig.on" :options="noticeOptions" />
          </a-form-item>
      ...
      <a-form :colon="false" :model="formConf" layout="vertical" class="config-form" v-show="activeKey === '6'">
        <a-form-item label="限时设置">
          <lydc-select v-model:value="formConf.timeLimitConfig.on" :options="overTimeMsgOptions" @change="onTimeLimitChange($event)" />
        </a-form-item>
        <a-form-item v-if="formConf.timeLimitConfig.on === 1">
          ...
          <div class="countersign-cell">
            <lydc-select class="!w-500px" v-model:value="formConf.timeLimitConfig.nodeLimit" :options="overTimeOptions" disabled />
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.noticeConfig.on" :options="overTimeMsgOptions" />
          </a-form-item>
        ...
        <a-form-item>
          ...
          <lydc-select v-model:value="formConf.overTimeConfig.on" :options="overTimeMsgOptions" :disabled="formConf.timeLimitConfig.on == 0" />
        </a-form-item>
...
<script lang="ts" setup>
  ...
  const titleContentOptions = computed(() => {
    ...
    const fields = props.usedFormItems.filter(
      o => o.__config__.lydcKey === 'input' || o.__config__.lydcKey === 'textarea' || o.__config__.lydcKey === 'inputNumber',
    );
