    ...
    <ScrollContainer class="config-content" v-show="activeKey !== '3'">
      <a-form :colon="false" layout="vertical" :model="formConf" class="config-form" v-show="activeKey === '1'">
        ...
        <a-form-item label="审批设置">
          <lydc-radio v-model:value="formConf.assigneeType" :options="typeOptions" class="type-radio" @change="onAssigneeTypeChange" />
          ...
          <a-form-item label="审批节点" class="!mb-0" v-if="formConf.assigneeType === 5">
            <lydc-select v-model:value="formConf.nodeId" placeholder="请选择" showSearch :options="nodeOptions" />
          </a-form-item>
          ...
          <a-form-item class="!mb-0 !mt-10px" v-if="formConf.assigneeType === 6">
            ...
            <lydc-select v-model:value="formConf.extraRule" placeholder="请选择" :options="extraRuleOptions" />
          </a-form-item>
        </a-form-item>
        <a-form-item label="审批方式">
          <lydc-radio v-model:value="formConf.counterSign" :options="counterSignOptions" class="counterSign-radio" />
        </a-form-item>
        <a-form-item label="设置会签流转规则" v-if="formConf.counterSign == 1">
          <div class="countersign-cell mb-10px">
            ...
            <lydc-select v-model:value="formConf.counterSignConfig.auditType" :options="auditTypeOptions" class="!w-120px !mx-10px" />
          ...
          <div class="countersign-cell">
            ...
            <lydc-select v-model:value="formConf.counterSignConfig.rejectType" :options="rejectTypeOptions" class="!w-120px !mx-10px" />
        ...
        <a-form-item>
          ...
          <a-form-item label="设置退回到的节点" class="!mb-0px">
            <lydc-select v-model:value="formConf.rejectStep" placeholder="请选择" :options="rejectStepOptions" showSearch />
          </a-form-item>
        </a-form-item>
        ...
        <a-form-item label="抄送设置">
          <lydc-users-select v-model:value="formConf.circulateUser" buttonType="button" modalTitle="添加抄送人" multiple />
          <a-form-item class="!pt-10px">
            <template #label>抄送人范围<BasicHelp text="抄送人员增加人员选择范围附加条件" /></template>
            <lydc-select v-model:value="formConf.extraCopyRule" :options="extraCopyRuleOptions" />
          </a-form-item>
      ...
      <div v-show="activeKey === '2'">
        ...
        <a-form :colon="false" :model="formConf" labelAlign="left" :labelCol="{ style: { width: '100px' } }" class="config-form">
          ...
          <a-form-item label="说明" class="normal-item-content">
            <lydc-textarea v-model:value="formConf.description" placeholder="请输入" />
          </a-form-item>
        </a-form>
      </div>
      ...
      <div v-show="activeKey === '5'">
        ...
        <a-form :colon="false" :model="formConf" layout="vertical" class="config-form">
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.approveMsgConfig.on" :options="nodeNoticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.rejectMsgConfig.on" :options="nodeNoticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.copyMsgConfig.on" :options="nodeNoticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.overTimeMsgConfig.on" :options="nodeNoticeOptions" />
          </a-form-item>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.noticeMsgConfig.on" :options="nodeNoticeOptions" />
          </a-form-item>
      ...
      <a-form :colon="false" :model="formConf" layout="vertical" class="config-form" v-show="activeKey === '6'">
        <a-form-item label="限时设置">
          <lydc-select v-model:value="formConf.timeLimitConfig.on" :options="nodeOverTimeMsgOptions" @change="onTimeLimitChange($event)" />
        </a-form-item>
        <a-form-item v-if="formConf.timeLimitConfig.on === 1">
          ...
          <div class="countersign-cell">
            <lydc-select class="!w-500px" v-model:value="formConf.timeLimitConfig.nodeLimit" :options="overTimeOptions" />
            <span class="!ml-10px">开始</span>
          </div>
          <div class="mt-10px" v-if="formConf.timeLimitConfig.nodeLimit === 2">
            <lydc-select class="!w-500px" v-model:value="formConf.timeLimitConfig.formField" :options="usedFormItems" showSearch allowClear />
          </div>
          ...
          <a-form-item>
            ...
            <lydc-select v-model:value="formConf.noticeConfig.on" :options="nodeOverTimeMsgOptions" />
          </a-form-item>
        ...
        <a-form-item>
          ...
          <lydc-select v-model:value="formConf.overTimeConfig.on" :options="nodeOverTimeMsgOptions" :disabled="formConf.timeLimitConfig.on == 0" />
        </a-form-item>
...
<script lang="ts" setup>
  ...
  function getRealAssignList(assignList) {
    let newAssignList = props.prevNodeList.map(o => {
      ...
      formFieldList = formFieldList.filter(o => o.__config__.lydcKey !== 'table');
      return {
        nodeId: o.nodeId,
