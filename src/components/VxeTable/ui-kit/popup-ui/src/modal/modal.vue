<script lang="ts" setup>
  ...
  import { useIsMobile, usePriorityValues, useSimpleLocale } from '/@/utils/composables/index';
  import { Expand, Shrink } from '/@/utils/icons/index';
  import {
    Dialog,
    DialogContent,
    DialogDescription,
    ...
    VbenLoading,
    VisuallyHidden,
  } from '/@/components/VxeTable/ui-kit/shadcn-ui/index';
  import { globalShareState } from '/@/utils/shared/src/global-state';
  import { cn } from '/@/utils/shared/src/cn';
  ...
  <Dialog :modal="false" :open="state?.isOpen" @update:open="() => modalApi?.close()">
    <DialogContent
      ...
      <DialogFooter
        ...
        <slot name="footer">
          <component :is="components.DefaultButton || VbenButton" v-if="showCancelButton" variant="ghost" @click="() => modalApi?.onCancel()">
