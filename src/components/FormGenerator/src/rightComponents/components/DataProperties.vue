<template>
  ...
  <a-form-item label=" " :labelCol="{ style: { width: '30px' } }">
    <lydc-radio v-model:value="activeData.__config__.dataType" :options="dataTypeOptions" optionType="button" buttonStyle="solid" @change="onDataTypeChange" />
  </a-form-item>
  <div class="options-list" v-if="activeData.__config__.dataType === 'static'">
    <template v-if="['treeSelect', 'cascader'].includes(activeData.__config__.lydcKey)">
  ...
  <div v-if="activeData.__config__.dataType === 'dictionary'">
    <a-form-item label="数据字典">
      <lydc-tree-select :options="dicOptions" v-model:value="activeData.__config__.dictionaryType" lastLevel allowClear @change="onDictionaryTypeChange" />
    </a-form-item>
  ...
  <div v-if="activeData.__config__.dataType === 'dynamic'">
    ...
    <a-form-item label="子级字段" v-if="['treeSelect', 'cascader'].includes(activeData.__config__.lydcKey)">
