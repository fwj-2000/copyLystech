  ...
  <a-modal
    ...
    <a-form ref="formRef" :model="formData" :rules="rules" :label-col="{ style: { width: '80px' } }" :colon="false" hideRequiredMark>
      <a-form-item label="填充符号" name="filler">
        <lydc-select v-model:value="formData.filler" placeholder="请选择" :options="fillerOptions" />
      </a-form-item>
      <a-form-item label="掩码规则" name="maskType">
        <lydc-select v-model:value="formData.maskType" placeholder="请选择" :options="maskTypeOptions" :listHeight="300" />
      </a-form-item>
      <template v-if="formData.maskType === 0">
        <a-form-item label="开头显示" name="prefixType">
          <lydc-select v-model:value="formData.prefixType" placeholder="请选择" :options="prefixTypeOptions" />
        </a-form-item>
        ...
        <a-form-item label="结尾显示" name="suffixType">
          <lydc-select v-model:value="formData.suffixType" placeholder="请选择" :options="suffixTypeOptions" />
        </a-form-item>
