<template>
  ...
  <a-form-item label="边框">
    <lydc-radio v-model:value="activeData.borderType" :options="borderTypeOptions" optionType="button" button-style="solid" class="right-radio" />
  </a-form-item>
  <template v-if="activeData.borderType != 'none'">
    <a-form-item label="边框颜色">
      <lydc-color-picker v-model:value="activeData.borderColor" size="small" />
    </a-form-item>
