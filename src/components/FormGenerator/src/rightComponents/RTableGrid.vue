<template>
  <a-form-item label="表格边框">
    <lydc-radio v-model:value="activeData.__config__.borderType" :options="borderTypeOptions" optionType="button" button-style="solid" class="right-radio" />
  </a-form-item>
  <template v-if="activeData.__config__.borderType != 'none'">
    <a-form-item label="边框颜色">
      <lydc-color-picker v-model:value="activeData.__config__.borderColor" size="small" />
    </a-form-item>
