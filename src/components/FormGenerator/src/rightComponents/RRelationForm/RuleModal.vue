<template>
  <BasicModal v-bind="$attrs" @register="registerModal" title="填充规则配置" :width="600" class="lydc-transfer-modal" @ok="handleSubmit" destroyOnClose>
...
<script lang="ts" setup>
  ...
  function init(data) {
    ...
    state.formFieldsOptions = cloneDeep(data.formFieldsOptions || []).filter(o => ['input', 'textarea'].includes(o.__config__.lydcKey));
