<template>
  ...
  <a-form-item label="关联功能">
    <LydcTreeSelect v-model:value="activeData.modelId" :options="treeData" placeholder="请选择" lastLevel allowClear @change="onModeIdChange" />
  </a-form-item>
  <a-form-item label="显示字段">
    <lydc-select v-model:value="activeData.relationField" placeholder="请选择" :options="fieldOptions" showSearch @dropdownVisibleChange="visibleChange" />
  </a-form-item>
