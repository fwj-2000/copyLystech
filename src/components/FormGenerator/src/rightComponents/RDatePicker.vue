    ...
    <a-form-item label="类型">
      ...
      <div class="mt-10px">
        ...
        <template v-else-if="activeData.__config__.startTimeType == 2">
          <lydc-select v-model:value="activeData.__config__.startRelationField" placeholder="请选择" :options="formFieldsOptions" />
        </template>
    ...
    <a-form-item label="类型">
      ...
      <div class="mt-10px">
        ...
        <template v-else-if="activeData.__config__.endTimeType == 2">
          <lydc-select v-model:value="activeData.__config__.endRelationField" placeholder="请选择" :options="formFieldsOptions" />
        </template>
...
<script lang="ts" setup>
  ...
  const formFieldsOptions = computed(() => {
    ...
    const loop = (data, parent?) => {
      ...
      if (data.__vModel__ && data.__config__.lydcKey === 'datePicker' && data.__vModel__ !== props.activeData.__vModel__) {
