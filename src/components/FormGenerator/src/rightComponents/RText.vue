<template>
  <a-form-item label="文本内容">
    <a-input v-model:value="activeData.content" placeholder="请输入" />
  </a-form-item>
  ...
  <a-form-item label="对齐方式">
    <lydc-radio v-model:value="activeData.textStyle['text-align']" :options="alignOptions" optionType="button" button-style="solid" class="right-radio" />
  </a-form-item>
  <a-form-item label="字体颜色">
    <lydc-color-picker v-model:value="activeData.textStyle['color']" size="small" />
  </a-form-item>
