<template>
  ...
  <a-form-item label="弹窗类型" v-if="showType === 'pc'">
    <lydc-select v-model:value="activeData.popupType" placeholder="请选择弹窗类型" :options="popupTypeOptions" />
  </a-form-item>
  ...
  <a-form-item label="关联功能">
    <LydcTreeSelect v-model:value="activeData.modelId" :options="treeData" placeholder="请选择关联功能" lastLevel allowClear @change="onModeIdChange" />
  </a-form-item>
