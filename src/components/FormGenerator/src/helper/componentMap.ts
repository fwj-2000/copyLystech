...
export const selectComponents: GenItem[] = [
  {
    __config__: {
      lydcKey: 'organizeSelect',
      label: '组织选择',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      tag: 'LydcOrganizeSelect',
  ...
  {
    __config__: {
      lydcKey: 'factoryAreaSelect',
      label: '厂区选择选择',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      tag: 'LydcFactoryAreaSelect',
      tagIcon: 'icon-ym icon-ym-tree-department1',
      tableAlign: 'left',
      tableFixed: 'none',
      className: [],
  ...
  {
    __config__: {
      lydcKey: 'popupTableSelect',
      label: '下拉表格',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      required: false,
      tag: 'LydcPopupTableSelect',
  ...
  {
    __config__: {
      lydcKey: 'autoComplete',
      label: '下拉补全',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      required: false,
      tag: 'LydcAutoComplete',
  ...
  {
    __config__: {
      lydcKey: 'relationForm',
      label: '关联表单',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      tag: 'LydcRelationForm',
  ...
  {
    __config__: {
      lydcKey: 'relationFormAttr',
      label: '关联表单属性',
      tipLabel: '',
      labelWidth: undefined,
      showLabel: true,
      tag: 'LydcRelationFormAttr',
