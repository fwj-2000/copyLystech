export const orgList = ['organizeSelect', 'depSelect', 'posSelect', 'userSelect', 'usersSelect', 'groupSelect', 'roleSelect', 'factoryAreaSelect'];
...
//不设置宽度
export const noWithList = [...layoutList, 'switch', 'radio', 'checkbox', 'uploadFile', 'uploadImg', 'colorPicker', 'rate', 'qrcode', 'barcode'];
