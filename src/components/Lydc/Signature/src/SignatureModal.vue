<template>
  <a-modal v-model:open="visible" title="选择签章" class="lydc-signature-modal" centered :maskClosable="false" :keyboard="false" :width="600">
    <template #closeIcon>
    ...
    <div class="sign-main">
      <a-form :colon="false" :labelCol="{ style: { width: '80px' } }" :model="dataForm" ref="formElRef">
        <a-form-item label="电子签章" name="innerValue">
          <lydc-select v-model:value="dataForm.innerValue" :options="options" showSearch allowClear />
        </a-form-item>
      </a-form>
    </div>
  </a-modal>
