...
<script lang="ts" setup>
  ...
  defineOptions({ name: 'LydcCheckbox', inheritAttrs: false });
  ...
  const getBindValue = computed(() => ({
    ...unref(attrs),
    class: unref(attrs).class ? `lydc-${props.direction}-checkbox ${unref(attrs).class}` : `lydc-${props.direction}-checkbox`,
  }));
