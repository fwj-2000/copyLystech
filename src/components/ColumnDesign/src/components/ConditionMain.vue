<template>
  <div class="condition-main">
    <div class="mb-10px" v-if="conditionList.length">
      ...
      <lydc-select v-model:value="matchLogic" placeholder="请选择" :options="logicOptions" class="!w-68px" />
    </div>
      ...
      <a-row :gutter="8" v-for="(child, childIndex) in item.groups" :key="index + childIndex" class="mt-10px">
        ...
        <a-col :span="5">
          <lydc-select
            ...
            placeholder="运算符号"
            :options="getSymbolOptions(child.lydcKey)"
        ...
        <a-col :span="showFieldValueType ? 8 : 12" v-if="child.fieldValueType !== 1">
          ...
          <template v-else-if="child.lydcKey === 'calculate'">
            <lydc-number-range v-model:value="child.fieldValue" :precision="child.precision || 0" :disabled="child.disabled" v-if="child.symbol == 'between'" />
            <lydc-input-number v-model:value="child.fieldValue" :precision="child.precision || 0" :disabled="child.disabled" placeholder="请输入" v-else />
          </template>
          <template v-else-if="['rate', 'slider'].includes(child.lydcKey)">
            <lydc-number-range
              v-model:value="child.fieldValue"
              :precision="child.lydcKey == 'rate' && child.allowHalf ? 1 : 0"
              :disabled="child.disabled"
          ...
          <div class="pt-3px" v-else-if="child.lydcKey === 'switch'">
            <lydc-switch v-model:value="child.fieldValue" :disabled="child.disabled" />
          </div>
          <template v-else-if="child.lydcKey === 'colorPicker'">
            <lydc-color-picker v-model:value="child.fieldValue" size="small" :disabled="child.disabled" />
          </template>
          <template v-else-if="child.lydcKey === 'timePicker'">
            <lydc-time-range v-model:value="child.fieldValue" :format="child.format" allowClear :disabled="child.disabled" v-if="child.symbol == 'between'" />
            <lydc-time-picker v-model:value="child.fieldValue" :format="child.format" allowClear :disabled="child.disabled" v-else />
          </template>
          <template v-else-if="['datePicker', 'createTime', 'modifyTime'].includes(child.lydcKey)">
            <lydc-date-range
              v-model:value="child.fieldValue"
              ...
              :disabled="child.disabled"
              v-if="child.symbol == 'between'" />
            <lydc-date-picker v-model:value="child.fieldValue" :format="child.format || 'YYYY-MM-DD HH:mm:ss'" allowClear :disabled="child.disabled" v-else />
          </template>
          <template v-else-if="['organizeSelect', 'currOrganize'].includes(child.lydcKey)">
          ...
          <template v-else-if="['depSelect'].includes(child.lydcKey)">
            <lydc-dep-select
              v-model:value="child.fieldValue"
              allowClear
              :selectType="child.selectType"
          ...
          <template v-else-if="['factoryAreaSelect'].includes(child.lydcKey)">
          ...
          <template v-else-if="child.lydcKey === 'roleSelect'">
            <lydc-role-select
              v-model:value="child.fieldValue"
              allowClear
              :selectType="child.selectType"
          ...
          <template v-else-if="child.lydcKey === 'groupSelect'">
            <lydc-group-select
              v-model:value="child.fieldValue"
              allowClear
              :selectType="child.selectType"
          ...
          <template v-else-if="child.lydcKey === 'posSelect'">
            <lydc-pos-select
              v-model:value="child.fieldValue"
              allowClear
              :selectType="child.selectType"
          ...
          <template v-else-if="child.lydcKey === 'currPosition'">
            <lydc-pos-select v-model:value="child.fieldValue" allowClear :multiple="child.multiple" :disabled="child.disabled" />
          </template>
          <template v-else-if="['createUser', 'modifyUser'].includes(child.lydcKey)">
            <lydc-user-select v-model:value="child.fieldValue" allowClear :multiple="child.multiple" :disabled="child.disabled" />
          </template>
          <template v-else-if="['userSelect'].includes(child.lydcKey)">
            <lydc-user-select
              v-model:value="child.fieldValue"
              allowClear
          ...
          <template v-else-if="['usersSelect'].includes(child.lydcKey)">
            <lydc-users-select
              v-model:value="child.fieldValue"
              allowClear
              :selectType="child.selectType"
          ...
          <template v-else-if="child.lydcKey === 'areaSelect'">
            <lydc-area-select
              v-model:value="child.fieldValue"
              :level="child.level"
              allowClear
          ...
          <template v-else-if="['select', 'radio', 'checkbox'].includes(child.lydcKey)">
            <lydc-select
              v-model:value="child.fieldValue"
              placeholder="请选择"
              showSearch
          ...
          <template v-else-if="child.lydcKey === 'cascader'">
            <lydc-cascader
              v-model:value="child.fieldValue"
              :options="child.options"
              :fieldNames="child.props"
          ...
          <template v-else-if="child.lydcKey === 'treeSelect'">
            <lydc-tree-select
              v-model:value="child.fieldValue"
              :options="child.options"
              :fieldNames="child.props"
          ...
          <template v-else-if="child.lydcKey === 'relationForm'">
            <lydc-relation-form
              v-model:value="child.fieldValue"
              placeholder="请选择"
          ...
          <template v-else-if="child.lydcKey === 'popupSelect' || child.lydcKey === 'popupTableSelect'">
            <lydc-popup-select
              v-model:value="child.fieldValue"
              placeholder="请选择"
          ...
          <template v-else-if="child.lydcKey === 'autoComplete'">
            <lydc-auto-complete
              v-model:value="child.fieldValue"
              placeholder="请输入"
              allowClear
...
<script lang="ts" setup>
  ...
  function init(data) {
    ...
    const fieldOptions = data.fieldOptions.filter(o => !notSupportList.includes(o.__config__.lydcKey));
  ...
  function onFieldChange(val, data, item, index, childIndex) {
    ...
    item.lydcKey = data.__config__?.lydcKey || '';
  ...
  function getSymbolOptions(lydcKey) {
    if (useSwitchSymbolList.includes(lydcKey)) return switchSymbolOptions;
    if (useRelationFormSymbolList.includes(lydcKey)) return relationFormSymbolOptions;
    if (useRangeSymbolList.includes(lydcKey)) return rangeSymbolOptions;
    if (useSelectSymbolList.includes(lydcKey)) return selectSymbolOptions;
    if (lydcKey == 'location') return locationSymbolOptions;
