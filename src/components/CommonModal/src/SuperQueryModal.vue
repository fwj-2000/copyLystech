<template>
  <BasicModal
    ...
    @ok="handleSubmit"
    destroyOnClose
    class="lydc-super-query-modal lydc-condition-modal">
...
<script lang="ts" setup>
  ...
  const state = reactive<State>({
    planList: [],
    conditionList: [
      { logic: 'and', groups: [{ field: '', symbol: '', lydcKey: '', fieldValueType: 2, fieldValue: undefined, fieldValueLydcKey: '', cellKey: +new Date() }] },
    ],
