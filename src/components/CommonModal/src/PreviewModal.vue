<template>
  <BasicModal v-bind="$attrs" @register="registerModal" :title="title" :footer="null" :width="600" class="lydc-add-modal lydc-preview-modal">
    <div class="add-main">
    ...
    <BasicModal v-bind="$attrs" @register="registerQrModal" :title="title" :footer="null" :width="400" class="lydc-qrcode-modal">
      <lydc-qrcode :staticText="qrCodeText" :width="280" />
