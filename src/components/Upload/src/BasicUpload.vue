<template>
  <div>
    <Space>
      <slot name="button" :openUploadModal="openUploadModal" :disabled="disabled">
        <a-button type="primary" @click="openUploadModal" preIcon="carbon:cloud-upload" :disabled="disabled">
