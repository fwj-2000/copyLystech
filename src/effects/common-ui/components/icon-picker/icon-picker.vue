<script setup lang="ts">
  ...
  import { usePagination } from '/@/effects/hooks/use-pagination';
  import { Grip, listIcons } from '/@/components/VxeTable/base/icons/src/index';
  import { EmptyIcon } from '/@/utils/icons';
...
<template>
  <VbenPopover v-model:open="visible" :content-props="{ align: 'end', alignOffset: -11, sideOffset: 8 }" content-class="p-0 pt-3">
    <template #trigger>
      <component :is="inputComponent" :[modelValueProp]="currentSelect" :placeholder="$t('ui.iconPicker.placeholder')">
        <template #[iconSlot]>
