<template>
  <Header :class="getHeaderClass">
    ...
    <div :class="`${prefixCls}-action`">
      ...
      <a-tooltip :title="t('layout.header.customMenus')" :mouseEnterDelay="0.5">
        <div :class="`${prefixCls}-action__item`" @click="openCustmMenusDrawer(true, {})">
          <i class="icon-ym icon-ym-extend-star-o" />
        </div>
      </a-tooltip>
      ...
      <a-tooltip
        ...
        placement="bottom"
        :mouseEnterDelay="0.5"
        v-if="getUserInfo.systemIds && getUserInfo.systemIds.length > 1 && !getLydcAppId()">
      ...
      <AppTimeZonePicker :showText="true" />
      ...
      <CustomMenusDrawer @register="registerCustmMenusDrawer" />
...
<script lang="ts">
  ...
  import { AppLogo, AppSearch, AppLocalePicker, AppTimeZonePicker, AppEnvTag } from '/@/components/Application';
  ...
  import CustomMenusDrawer from './components/CustomMenusDrawer.vue';
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const [registerCustmMenusDrawer, { openDrawer: openCustmMenusDrawer }] = useDrawer();
      ...
      return {
        ...
        registerCustmMenusDrawer,
        openCustmMenusDrawer,
